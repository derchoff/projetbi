...
public class MAIN implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJECTBI_MAIN = new byte[0];
		static byte[] commonByteArray_PROJECTBI_MAIN = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECTBI_MAIN.length) {
					if (length < 1024 && commonByteArray_PROJECTBI_MAIN.length == 0) {
						commonByteArray_PROJECTBI_MAIN = new byte[1024];
					} else {
						commonByteArray_PROJECTBI_MAIN = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECTBI_MAIN, 0, length);
				strReturn = new String(commonByteArray_PROJECTBI_MAIN, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECTBI_MAIN) {
...
///////////////////////    			
						...
						String message_tSendMail_1 = (("Message d'erreur: " + String.valueOf(row2)) == null
								|| "".equals("Message d'erreur: " + String.valueOf(row2))) ? "\"\""
										: ("Message d'erreur: " + String.valueOf(row2));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
					...
					projectbi.dimension_indicateurs_0_1.dimension_indicateurs childJob_tRunJob_1 = new projectbi.dimension_indicateurs_0_1.dimension_indicateurs();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					projectbi.dimension_produit_0_1.dimension_produit childJob_tRunJob_2 = new projectbi.dimension_produit_0_1.dimension_produit();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_4 = 0; i_tFileList_4 < list_tFileList_4.size(); i_tFileList_4++) {
					...
					projectbi.integration_magasins_0_1.integration_magasins childJob_tRunJob_3 = new projectbi.integration_magasins_0_1.integration_magasins();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_5 = 0; i_tFileList_5 < list_tFileList_5.size(); i_tFileList_5++) {
					...
					projectbi.dimension_date_0_1.dimension_date childJob_tRunJob_6 = new projectbi.dimension_date_0_1.dimension_date();
					// pass DataSources
					...
					projectbi.integration_objectif_0_1.integration_objectif childJob_tRunJob_5 = new projectbi.integration_objectif_0_1.integration_objectif();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_6 = 0; i_tFileList_6 < list_tFileList_6.size(); i_tFileList_6++) {
					...
					projectbi.integration_ventes_0_1.integration_ventes childJob_tRunJob_4 = new projectbi.integration_ventes_0_1.integration_ventes();
					// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MAIN.class.getClassLoader()
					.getResourceAsStream("projectbi/main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 211556 characters generated by Talend Open Studio for Data Integration on the
 * 6 mai 2019 21:51:19 SBT
 ************************************************************************************************/