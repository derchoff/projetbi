		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
					...
					projetbi.initialisation_de_la_dimension_indicateurs_0_1.initialisation_de_la_dimension_indicateurs childJob_tRunJob_1 = new projetbi.initialisation_de_la_dimension_indicateurs_0_1.initialisation_de_la_dimension_indicateurs();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					projetbi.initialisation_de_la_dimension_produit_0_1.initialisation_de_la_dimension_produit childJob_tRunJob_2 = new projetbi.initialisation_de_la_dimension_produit_0_1.initialisation_de_la_dimension_produit();
					// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_4 = 0; i_tFileList_4 < list_tFileList_4.size(); i_tFileList_4++) {
					...
					projetbi.integration_des_magasins_et_region_0_1.integration_des_magasins_et_region childJob_tRunJob_3 = new projetbi.integration_des_magasins_et_region_0_1.integration_des_magasins_et_region();
					// pass DataSources
	...
	public void tFileList_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				maskList_tFileList_6.add(context.mask_prevision_ventes);
				...
				for (int i_tFileList_6 = 0; i_tFileList_6 < list_tFileList_6.size(); i_tFileList_6++) {
					...
					projetbi.initialisation_de_la_dimension_date_0_1.initialisation_de_la_dimension_date childJob_tRunJob_6 = new projetbi.initialisation_de_la_dimension_date_0_1.initialisation_de_la_dimension_date();
					// pass DataSources
...
/************************************************************************************************
 * 178539 characters generated by Talend Open Studio for Data Integration on the
 * 21 avril 2019 22:34:41 CEST
 ************************************************************************************************/