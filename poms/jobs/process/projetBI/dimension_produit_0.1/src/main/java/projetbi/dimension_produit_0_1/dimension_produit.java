 ...
 * Description: Lit un fichier Excel pour en extraire les produit à ajouter en
 * BDD <br>
 * 
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row9 != null && tHash_Lookup_row9.getCount(row9HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row9.Nom = '" + row9HashKey.Nom +
							// "'");
						} // G 071
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					String update_tDBOutput_1 = "UPDATE `" + "produit"
							+ "` SET `type_produit` = ? WHERE `type_produit` = ?";
...
// ###############################
					...
					try {
						...
						sheetList_tFileInputExcel_1.addAll(
								regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "produits", false));
...
// Start of branch "produits"
									if (produits != null) {
										...
										if (produits.type_produit == null) {
											...
											pstmtUpdate_tDBOutput_1.setString(1, produits.type_produit);
										}
										...
										try {
											...
											if (updateFlag_tDBOutput_1 == 0) {
												...
												if (produits.type_produit == null) {
													...
													pstmtInsert_tDBOutput_1.setString(1, produits.type_produit);
												}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimension_produit.class.getClassLoader()
					.getResourceAsStream("projetbi/dimension_produit_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimension_produit.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimension_produit");
		}
...
/************************************************************************************************
 * 205147 characters generated by Talend Open Studio for Data Integration on the
 * 28 avril 2019 10:31:01 CEST
 ************************************************************************************************/