...
package projectbi.dimension_produit_0_1;
...
public static class efface_indicateurStruct implements routines.system.IPersistableRow<efface_indicateurStruct> {
    final static byte[] commonByteArrayLock_PROJECTBI_dimension_produit = new byte[0];
    static byte[] commonByteArray_PROJECTBI_dimension_produit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJECTBI_dimension_produit.length) {
				if(length < 1024 && commonByteArray_PROJECTBI_dimension_produit.length == 0) {
   					commonByteArray_PROJECTBI_dimension_produit = new byte[1024];
				} else {
   					commonByteArray_PROJECTBI_dimension_produit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJECTBI_dimension_produit, 0, length);
			strReturn = new String(commonByteArray_PROJECTBI_dimension_produit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJECTBI_dimension_produit) {
 ...
 */
	NB_ITERATE_tRunJob_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate6", 1, "exec" + NB_ITERATE_tRunJob_1);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate6", 2, "exec" + NB_ITERATE_tRunJob_1);
						}				
	...
	NB_ITERATE_tRunJob_2++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate7", 1, "exec" + NB_ITERATE_tRunJob_2);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate7", 2, "exec" + NB_ITERATE_tRunJob_2);
						}				
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_produit.class.getClassLoader().getResourceAsStream("projectbi/dimension_produit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     205104 characters generated by Talend Open Studio for Data Integration 
