...
/**
 * Job: dimension_indicateurs Purpose: Initialisation de la dimension
 * "indicateur"<br>
 * Description: Lit un fichier Excel pour en extraire les indicateurs à ajouter
 * <br>
 * 
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row9 != null && tHash_Lookup_row9.getCount(row9HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row9.Abbreviation = '" +
							// row9HashKey.Abbreviation + "'");
						} // G 071
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (obj_tRunJob_3 != null) {
						paraList_tRunJob_3.add(
								"--context_param nom_colonnes=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
					} else {
					...
					if (obj_tRunJob_3 != null) {
						paraList_tRunJob_3
								.add("--context_param nom_onglet=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
					} else {
					...
					String update_tDBOutput_1 = "UPDATE `" + "indicateur"
							+ "` SET `nom` = ?,`abbreviation` = ? WHERE `abbreviation` = ?";

					java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1
							.prepareStatement(update_tDBOutput_1);
					resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
					String insert_tDBOutput_1 = "INSERT INTO `" + "indicateur"
							+ "` (`nom`,`abbreviation`) VALUES (?,?)";
...
// ###############################
					...
					class KeyStruct_tUniqRow_1 {
						...
						public int hashCode() {
							if (this.hashCodeDirty) {
								...
								result = prime * result
										+ ((this.Abbreviation == null) ? 0 : this.Abbreviation.hashCode());
					...
					class RowSetValueUtil_tSchemaComplianceCheck_1 {
						...
						void setRowValue_0(row1Struct row1) {
							try {
								if (row1.Abbreviation != null && (!"".equals(row1.Abbreviation))) {
							...
							errorCodeThrough = 0;
							resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,
									resultErrorMessageThrough, "Abbreviation:");
							errorMessageThrough = "";
							try {
					...
					try {
						...
						sheetList_tFileInputExcel_1.addAll(
								regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "indicateurs", true));
...
// Start of branch "row2"
									if (row2 != null) {
										...
										if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
											...
											row3.Abbreviation = row2.Abbreviation;
											row3.Nom = row2.Nom;
...
// Start of branch "indicateurs"
											if (indicateurs != null) {
												...
												if (indicateurs.nom == null) {
													...
													pstmtUpdate_tDBOutput_1.setString(1, indicateurs.nom);
												}

												if (indicateurs.abbreviation == null) {
													pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(2, indicateurs.abbreviation);
												}
												...
												try {
													...
													if (updateFlag_tDBOutput_1 == 0) {
														...
														if (indicateurs.nom == null) {
															...
															pstmtInsert_tDBOutput_1.setString(1, indicateurs.nom);
														}
									...
									if (row4 != null) {
										...
										try {
											talendLogs_LOGS.addMessage("tDie", "tDie_2", 5,
													"la structure du fichier Excel est incorrecte", 4);
											talendLogs_LOGSProcess(globalMap);
											...
											globalMap.put("tDie_2_DIE_MESSAGE",
													"la structure du fichier Excel est incorrecte");
...
// ###############################      
					...
					// source node:tUniqRow_2 - inputs:(row6) outputs:(row9,row9) | target
					...
					class RowSetValueUtil_tSchemaComplianceCheck_2 {
						...
						void setRowValue_0(row5Struct row5) {
							try {
								if (row5.Abbreviation != null && (!"".equals(row5.Abbreviation))) {
							...
							errorMessageThrough = "";
							try {
								if (row5.Nom != null && (!"".equals(row5.Nom))) {
					...
					try {
						...
						sheetList_tFileInputExcel_2.addAll(
								regexUtil_tFileInputExcel_2.getSheets(workbook_tFileInputExcel_2, "indicateurs", true));
...
// Start of branch "row6"
									if (row6 != null) {
										...
										if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
											...
											row9.Abbreviation = row6.Abbreviation;
											row9.Nom = row6.Nom;
											if (row9 == null) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimension_indicateurs.class.getClassLoader()
					.getResourceAsStream("projetbi/dimension_indicateurs_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimension_indicateurs.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimension_indicateurs");
		}
...
/************************************************************************************************
 * 268204 characters generated by Talend Open Studio for Data Integration on the
 * 28 avril 2019 10:30:49 CEST
 ************************************************************************************************/