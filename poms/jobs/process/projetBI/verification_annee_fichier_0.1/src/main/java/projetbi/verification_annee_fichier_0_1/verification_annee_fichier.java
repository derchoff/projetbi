...
/**
 * Job: verification_annee_fichier Purpose: <br>
 * Description:  <br>
...
throw new Exception("L'année dans le nom de fichier '"+  context.nom_fichier +"' n'est pas valide.");
}

//l'annee n'est pas sur 4 chiffres
if (annee < 1000) {
throw new Exception("L'année dans le nom de fichier '"+  context.nom_fichier +"' n'est pas valide. format attendu : yyyy.");
}
...
if (context.verifier_mois) {
	...
	try {
		...
		throw new Exception("Impossible d'extraire le mois dans le nom de fichier '"+  context.nom_fichier +"'.");	
	}

	if (!projetBi.getNormalizedMonthList().contains(mois)) {
		throw new Exception("Le mois dans le nom de fichier '"+  context.nom_fichier +"' est absent : attendu avec la première lettre en majuscule et sans accent.");	
	}
}
...
/************************************************************************************************
 *     92015 characters generated by Talend Open Studio for Data Integration 
