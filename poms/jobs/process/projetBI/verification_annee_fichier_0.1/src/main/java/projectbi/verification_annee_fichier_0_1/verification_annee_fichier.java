...
package projectbi.verification_annee_fichier_0_1;
...
if (context.verifier_mois) {
	...
	if (!projetBi.getNormalizedMonthList().contains(mois)) {
		throw new Exception("Le mois dans le nom de fichier '"+  context.nom_fichier +"' est invalide. Format attendu : *_Mois_yyyy.xls");	
	}
}
...
public static class row_talendStats_STATSStruct implements routines.system.IPersistableRow<row_talendStats_STATSStruct> {
    final static byte[] commonByteArrayLock_PROJECTBI_verification_annee_fichier = new byte[0];
    static byte[] commonByteArray_PROJECTBI_verification_annee_fichier = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJECTBI_verification_annee_fichier.length) {
				if(length < 1024 && commonByteArray_PROJECTBI_verification_annee_fichier.length == 0) {
   					commonByteArray_PROJECTBI_verification_annee_fichier = new byte[1024];
				} else {
   					commonByteArray_PROJECTBI_verification_annee_fichier = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJECTBI_verification_annee_fichier, 0, length);
			strReturn = new String(commonByteArray_PROJECTBI_verification_annee_fichier, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJECTBI_verification_annee_fichier) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = verification_annee_fichier.class.getClassLoader().getResourceAsStream("projectbi/verification_annee_fichier_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     92314 characters generated by Talend Open Studio for Data Integration 
