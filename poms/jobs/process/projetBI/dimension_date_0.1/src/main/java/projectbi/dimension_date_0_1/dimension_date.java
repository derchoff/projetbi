...
package projectbi.dimension_date_0_1;
...
public static class datesStruct implements routines.system.IPersistableRow<datesStruct> {
    final static byte[] commonByteArrayLock_PROJECTBI_dimension_date = new byte[0];
    static byte[] commonByteArray_PROJECTBI_dimension_date = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJECTBI_dimension_date.length) {
				if(length < 1024 && commonByteArray_PROJECTBI_dimension_date.length == 0) {
   					commonByteArray_PROJECTBI_dimension_date = new byte[1024];
				} else {
   					commonByteArray_PROJECTBI_dimension_date = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJECTBI_dimension_date, 0, length);
			strReturn = new String(commonByteArray_PROJECTBI_dimension_date, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJECTBI_dimension_date) {
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "date" + "` SET `mois` = ?,`annee` = ?,`datetime` = ? WHERE `datetime` = ?";
	    
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "date" + "` (`mois`,`annee`,`datetime`) VALUES (?,?,?)";
...
Var.months = projetBi.getNormalizedMonthList();
...
} else {pstmtUpdate_tDBOutput_1.setString(1, dates.mois);
}

                    pstmtUpdate_tDBOutput_1.setInt(2, dates.annee);
...
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.DATE);
                    ...
                    if(dates.datetime != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(4 + count_tDBOutput_1, new java.sql.Timestamp(dates.datetime.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, dates.mois);
}

                        pstmtInsert_tDBOutput_1.setInt(2, dates.annee);
...
int count_tDBOutput_3=0;
	    ...
	    String delete_tDBOutput_3 = "DELETE FROM `" + "date" + "` WHERE `datetime` = ?";
...
suppression_N_moins_2_tmp.datetime = projetBi.getDateFromMonthAndYear(row3.SEQ_NUM3, Var.year) ;
...
if(suppression_N_moins_2 != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(suppression_N_moins_2.datetime != null) {
date_tDBOutput_3 = suppression_N_moins_2.datetime.getTime();
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "date" + "` SET `mois` = ?,`annee` = ?,`datetime` = ? WHERE `datetime` = ?";
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO `" + "date" + "` (`mois`,`annee`,`datetime`) VALUES (?,?,?)";
...
} else {pstmtUpdate_tDBOutput_2.setString(1, old_dates.mois);
}

                    pstmtUpdate_tDBOutput_2.setInt(2, old_dates.annee);
...
pstmtUpdate_tDBOutput_2.setString(3, "0000-00-00 00:00:00");
} else {pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(date_tDBOutput_2));
}
} else {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.DATE);
}


                    if(old_dates.datetime != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(4 + count_tDBOutput_2, new java.sql.Timestamp(old_dates.datetime.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(4 + count_tDBOutput_2, java.sql.Types.TIMESTAMP);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, old_dates.mois);
}

                        pstmtInsert_tDBOutput_2.setInt(2, old_dates.annee);

                        if(old_dates.datetime != null) {
date_tDBOutput_2 = old_dates.datetime.getTime();
if(date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
pstmtInsert_tDBOutput_2.setString(3, "0000-00-00 00:00:00");
} else {pstmtInsert_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(date_tDBOutput_2));
}
} else {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.DATE);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_date.class.getClassLoader().getResourceAsStream("projectbi/dimension_date_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     167385 characters generated by Talend Open Studio for Data Integration 
