		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE `" + "date"
						+ "` SET `mois` = ?,`annee` = ?,`datetime` = ? WHERE `datetime` = ?";
...
// Start of branch "dates"
					if (dates != null) {
						...
						if (dates.mois == null) {
							...
							pstmtUpdate_tDBOutput_1.setString(1, dates.mois);
						}
						...
						if (dates.datetime != null) {
							...
							if (date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
								...
								pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(date_tDBOutput_1));
							}
						} else {
						...
						if (dates.datetime != null) {
							pstmtUpdate_tDBOutput_1.setTimestamp(4 + count_tDBOutput_1,
									new java.sql.Timestamp(dates.datetime.getTime()));
						} else {
						...
						try {
							...
							if (updateFlag_tDBOutput_1 == 0) {
								...
								if (dates.mois == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, dates.mois);
								}
...
// Start of branch "old_dates"
					if (old_dates != null) {
						...
						if (old_dates.mois == null) {
							...
							pstmtUpdate_tDBOutput_2.setString(1, old_dates.mois);
						}
						...
						if (old_dates.datetime != null) {
							...
							if (date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
								...
								pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(date_tDBOutput_2));
							}
						} else {
						...
						if (old_dates.datetime != null) {
							pstmtUpdate_tDBOutput_2.setTimestamp(4 + count_tDBOutput_2,
						...
						try {
							...
							if (updateFlag_tDBOutput_2 == 0) {
								...
								if (old_dates.mois == null) {
									...
									pstmtInsert_tDBOutput_2.setString(1, old_dates.mois);
								}
					...
					if (suppression_N_moins_2 != null) {
						...
						if (suppression_N_moins_2.datetime != null) {
							...
							if (date_tDBOutput_3 < year1_tDBOutput_3 || date_tDBOutput_3 >= year10000_tDBOutput_3) {
								...
								pstmt_tDBOutput_3.setTimestamp(1, new java.sql.Timestamp(date_tDBOutput_3));
							}
						} else {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimension_date.class.getClassLoader()
					.getResourceAsStream("projetbi/dimension_date_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 167316 characters generated by Talend Open Studio for Data Integration on the
 * 24 avril 2019 14:36:35 CEST
 ************************************************************************************************/