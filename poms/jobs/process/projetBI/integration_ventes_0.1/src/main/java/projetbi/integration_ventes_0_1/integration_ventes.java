...
public class integration_ventes implements TalendJob {
	...
	public void tFileExcelWorkbookOpen_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileExcelSheetList_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add(
								"--context_param verifier_mois=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1.add("--context_param verifier_mois="
								+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}
					...
					try {
						...
						while (rs_tDBInput_6.next()) {
							...
							if (denormalize_result_tDenormalize_2_DenormalizeOut == null) {
								...
								if (!denormalize_result_tDenormalize_2_DenormalizeOut.type_produit
										.contains(row10.type_produit)) {
									denormalize_result_tDenormalize_2_DenormalizeOut.type_produit
...
//generate result begin
						...
						denormalize_row_tDenormalize_2_DenormalizeOut.type_produit = sb_tDenormalize_2_DenormalizeOut
								.toString();
...
//generate result end
					...
					for (OnRowsEndStructtDenormalize_2 row_tDenormalize_2_ArrayIn : list_tDenormalize_2_ArrayIn) {
						...
						obj_tRunJob_2 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY"))
					...
					try {
						...
						tFileExcelWorkbookOpen_1
								.setInputFile(((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY"))
										+ System.getProperty("file.separator")
										+ ((String) globalMap.get("tFileList_1_CURRENT_FILE")), true);
...
// ###############################
					...
					tFileExcelSheetList_1.setWorkbook(
					...
					for (; tFileExcelSheetList_1_sheetIndex < countSheets_tFileExcelSheetList_1; tFileExcelSheetList_1_sheetIndex++) {
						tFileExcelSheetList_1_sheetName = tFileExcelSheetList_1
								.getSheetName(tFileExcelSheetList_1_sheetIndex);
						tFileExcelSheetList_1_countRows = tFileExcelSheetList_1
								.getCountSheetRows(tFileExcelSheetList_1_sheetIndex);
...
// # Output table : 'liste_indicateurs'
								...
								liste_indicateurs_tmp.nom_fichier = ((String) globalMap
...
// # Output table : 'liste_colonnes'
									...
									liste_colonnes_tmp.nom_colonnes = String.format("%s_%s",
											liste_indicateurs.abbreviation,
											projetBi.getMonthFromFile(liste_indicateurs.nom_fichier));
...
// Start of branch "liste_colonnes"
								if (liste_colonnes != null) {
									...
									if (hash_SHEET_NAME_tDenormalize_1_DenormalizeOut
											.containsKey(liste_colonnes.SHEET_NAME)) {
										denormalize_result_tDenormalize_1_DenormalizeOut = hash_SHEET_NAME_tDenormalize_1_DenormalizeOut
												.get(liste_colonnes.SHEET_NAME);
										if (!denormalize_result_tDenormalize_1_DenormalizeOut.nom_colonnes
												.contains(liste_colonnes.nom_colonnes)) {
											denormalize_result_tDenormalize_1_DenormalizeOut.nom_colonnes
													.add(liste_colonnes.nom_colonnes);
										}
									} else {
										...
										hash_SHEET_NAME_tDenormalize_1_DenormalizeOut.put(liste_colonnes.SHEET_NAME,
...
//generate result begin
						java.util.Iterator<String> SHEET_NAME_iterator_tDenormalize_1_DenormalizeOut = hash_SHEET_NAME_tDenormalize_1_DenormalizeOut
								.keySet().iterator();

						while (SHEET_NAME_iterator_tDenormalize_1_DenormalizeOut.hasNext()) {

							String key_SHEET_NAME_tDenormalize_1_DenormalizeOut = SHEET_NAME_iterator_tDenormalize_1_DenormalizeOut
									.next();

							denormalize_result_tDenormalize_1_DenormalizeOut = hash_SHEET_NAME_tDenormalize_1_DenormalizeOut
									.get(key_SHEET_NAME_tDenormalize_1_DenormalizeOut);
							...
							denormalize_row_tDenormalize_1_DenormalizeOut.nom_colonnes = sb_tDenormalize_1_DenormalizeOut
									.toString();
...
//generate result end
					...
					for (OnRowsEndStructtDenormalize_1 row_tDenormalize_1_ArrayIn : list_tDenormalize_1_ArrayIn) {
						...
						obj_tRunJob_3 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY"))
								+ System.getProperty("file.separator")
								+ ((String) globalMap.get("tFileList_1_CURRENT_FILE"));
						...
						if (obj_tRunJob_3 != null) {
							paraList_tRunJob_3.add("--context_param nom_colonnes="
						...
						if (obj_tRunJob_3 != null) {
							paraList_tRunJob_3.add(
									"--context_param nom_onglet=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
						} else {
							paraList_tRunJob_3.add("--context_param nom_onglet="
									+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
						}
					...
					String update_tDBOutput_1 = "UPDATE `" + "vente"
							+ "` SET `id_produit` = ?,`id_magasin` = ?,`id_devise` = ?,`id_date` = ?,`id_indicateur` = ?,`reel` = ? WHERE `id_produit` = ? AND `id_magasin` = ? AND `id_date` = ? AND `id_indicateur` = ?";
					...
					String insert_tDBOutput_1 = "INSERT INTO `" + "vente"
							+ "` (`id_produit`,`id_magasin`,`id_devise`,`id_date`,`id_indicateur`,`reel`) VALUES (?,?,?,?,?,?)";
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_5 - inputs:(after_tFileList_1) outputs:(row8,row8) |
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integration_ventes.class.getClassLoader()
					.getResourceAsStream("projetbi/integration_ventes_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = integration_ventes.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : integration_ventes");
		}
