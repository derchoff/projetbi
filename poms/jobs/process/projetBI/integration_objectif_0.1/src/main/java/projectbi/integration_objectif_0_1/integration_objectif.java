...
package projectbi.integration_objectif_0_1;
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_PROJECTBI_integration_objectif = new byte[0];
    static byte[] commonByteArray_PROJECTBI_integration_objectif = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJECTBI_integration_objectif.length) {
				if(length < 1024 && commonByteArray_PROJECTBI_integration_objectif.length == 0) {
   					commonByteArray_PROJECTBI_integration_objectif = new byte[1024];
				} else {
   					commonByteArray_PROJECTBI_integration_objectif = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJECTBI_integration_objectif, 0, length);
			strReturn = new String(commonByteArray_PROJECTBI_integration_objectif, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJECTBI_integration_objectif) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		projectbi.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes childJob_tRunJob_4 = new projectbi.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integration_objectif.class.getClassLoader().getResourceAsStream("projectbi/integration_objectif_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     400377 characters generated by Talend Open Studio for Data Integration 
