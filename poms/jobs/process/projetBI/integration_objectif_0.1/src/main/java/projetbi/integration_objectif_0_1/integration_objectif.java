...
public class integration_objectif implements TalendJob {
	...
	public void tFileExcelWorkbookOpen_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileExcelSheetList_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tAdvancedHash_noms_colonnes_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDenormalize_2_DenormalizeOut_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDenormalize_2_ArrayIn_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_1 - inputs:(after_tFileList_3) outputs:(row4,row4) |
				// target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
				// linked node: tMap_2 - inputs:(row4,row2,row3,row5,row14,row6)
				// outputs:(ventes)
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_2 - inputs:(after_tFileList_3) outputs:(row2,row2) |
				...
				String url_tDBInput_2 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
						+ context.db_database + "?" + "noDatetimeStringSync=true";
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_3 - inputs:(after_tFileList_3) outputs:(row3,row3) |
				...
				String url_tDBInput_3 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
						+ context.db_database + "?" + "noDatetimeStringSync=true";
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_4 - inputs:(after_tFileList_3) outputs:(row5,row5) |
				...
				String url_tDBInput_4 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
						+ context.db_database + "?" + "noDatetimeStringSync=true";
	...
	public void tDBInput_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBInput_6 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
						+ context.db_database + "?" + "noDatetimeStringSync=true";
				...
				// source node:tSortRow_1_SortIn - inputs:(OnRowsEnd) outputs:(row13,row13) |
				// target node:tAdvancedHash_row13 - inputs:(row13) outputs:()
				// linked node: tMap_3 - inputs:(row13,row8)
				// outputs:(noms_colonnes,noms_colonnes)
	...
	public void tDBInput_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_7 - inputs:(after_tFileList_3) outputs:(row14,row14) |
	...
	public static class OnRowsEndStructtDenormalize_2
			implements routines.system.IPersistableRow<OnRowsEndStructtDenormalize_2> {
		final static byte[] commonByteArrayLock_PROJETBI_integration_objectif = new byte[0];
		static byte[] commonByteArray_PROJETBI_integration_objectif = new byte[0];
	...
	public static class colonnes_en_ligne_uniqueStruct
			implements routines.system.IPersistableRow<colonnes_en_ligne_uniqueStruct> {
		final static byte[] commonByteArrayLock_PROJETBI_integration_objectif = new byte[0];
		static byte[] commonByteArray_PROJETBI_integration_objectif = new byte[0];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					String url_tDBInput_5 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
							+ context.db_database + "?" + "noDatetimeStringSync=true";
					...
					try {
						...
						while (rs_tDBInput_5.next()) {
							...
							if (denormalize_result_tDenormalize_1_DenormalizeOut == null) {
								...
								if (!denormalize_result_tDenormalize_1_DenormalizeOut.type_produit
										.contains(row10.type_produit)) {
									denormalize_result_tDenormalize_1_DenormalizeOut.type_produit
											.add(row10.type_produit);
								}
							} else {
								if (!denormalize_result_tDenormalize_1_DenormalizeOut.type_produit
										.contains(row10.type_produit)) {
...
//generate result begin
						...
						denormalize_row_tDenormalize_1_DenormalizeOut.type_produit = sb_tDenormalize_1_DenormalizeOut
								.toString();
...
//generate result end
					...
					for (OnRowsEndStructtDenormalize_1 row_tDenormalize_1_ArrayIn : list_tDenormalize_1_ArrayIn) {
						...
						obj_tRunJob_2 = ((String) globalMap.get("tFileList_3_CURRENT_FILEDIRECTORY"))
						...
						if (obj_tRunJob_2 != null) {
							paraList_tRunJob_2.add(
									"--context_param nom_onglets=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
						} else {
							paraList_tRunJob_2.add("--context_param nom_onglets="
									+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
						}
					...
					try {
						...
						tFileExcelWorkbookOpen_2
								.setInputFile(((String) globalMap.get("tFileList_3_CURRENT_FILEDIRECTORY"))
										+ System.getProperty("file.separator")
										+ ((String) globalMap.get("tFileList_3_CURRENT_FILE")), true);
...
// # Lookup's keys initialization
					...
					org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<noms_colonnesStruct> tHash_Lookup_noms_colonnes = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<noms_colonnesStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<noms_colonnesStruct>) globalMap
							.get("tHash_Lookup_noms_colonnes"));
...
// ###############################
					...
					tFileExcelSheetList_2.setWorkbook(
					...
					for (; tFileExcelSheetList_2_sheetIndex < countSheets_tFileExcelSheetList_2; tFileExcelSheetList_2_sheetIndex++) {
						tFileExcelSheetList_2_sheetName = tFileExcelSheetList_2
								.getSheetName(tFileExcelSheetList_2_sheetIndex);
						tFileExcelSheetList_2_countRows = tFileExcelSheetList_2
								.getCountSheetRows(tFileExcelSheetList_2_sheetIndex);
						...
						while ((tHash_Lookup_noms_colonnes != null && tHash_Lookup_noms_colonnes.hasNext())
								|| forceLoopnoms_colonnes) { // G_TM_M_043
...
// Start of branch "colonnes_en_ligne_unique"
							if (colonnes_en_ligne_unique != null) {
								...
								if (hash_SHEET_NAME_tDenormalize_2_DenormalizeOut
										.containsKey(colonnes_en_ligne_unique.SHEET_NAME)) {
									denormalize_result_tDenormalize_2_DenormalizeOut = hash_SHEET_NAME_tDenormalize_2_DenormalizeOut
											.get(colonnes_en_ligne_unique.SHEET_NAME);
									if (!denormalize_result_tDenormalize_2_DenormalizeOut.colonne
											.contains(colonnes_en_ligne_unique.colonne)) {
										denormalize_result_tDenormalize_2_DenormalizeOut.colonne
												.add(colonnes_en_ligne_unique.colonne);
									}
								} else {
									...
									hash_SHEET_NAME_tDenormalize_2_DenormalizeOut.put(
											colonnes_en_ligne_unique.SHEET_NAME,
...
//generate result begin
						java.util.Iterator<String> SHEET_NAME_iterator_tDenormalize_2_DenormalizeOut = hash_SHEET_NAME_tDenormalize_2_DenormalizeOut
								.keySet().iterator();

						while (SHEET_NAME_iterator_tDenormalize_2_DenormalizeOut.hasNext()) {

							String key_SHEET_NAME_tDenormalize_2_DenormalizeOut = SHEET_NAME_iterator_tDenormalize_2_DenormalizeOut
									.next();

							denormalize_result_tDenormalize_2_DenormalizeOut = hash_SHEET_NAME_tDenormalize_2_DenormalizeOut
									.get(key_SHEET_NAME_tDenormalize_2_DenormalizeOut);
							...
							for (String temp_tDenormalize_2_DenormalizeOut : denormalize_result_tDenormalize_2_DenormalizeOut.colonne) {
								...
								if (sb_tDenormalize_2_DenormalizeOut == null) {
									...
									sb_tDenormalize_2_DenormalizeOut.append(",")
											.append(temp_tDenormalize_2_DenormalizeOut);

								}

							}

							denormalize_row_tDenormalize_2_DenormalizeOut.colonne = sb_tDenormalize_2_DenormalizeOut
									.toString();
...
//generate result end
					...
					for (OnRowsEndStructtDenormalize_2 row_tDenormalize_2_ArrayIn : list_tDenormalize_2_ArrayIn) {
						...
						obj_tRunJob_4 = ((String) globalMap.get("tFileList_3_CURRENT_FILEDIRECTORY"))
								+ System.getProperty("file.separator")
								+ ((String) globalMap.get("tFileList_3_CURRENT_FILE"));
						if (obj_tRunJob_4 != null) {
							paraList_tRunJob_4.add(
									"--context_param nom_fichier=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
						} else {
							paraList_tRunJob_4.add("--context_param nom_fichier="
									+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
						}
						...
						if (obj_tRunJob_4 != null) {
							paraList_tRunJob_4.add("--context_param nom_colonnes="
						...
						if (obj_tRunJob_4 != null) {
							paraList_tRunJob_4.add(
									"--context_param nom_onglet=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
						} else {
							paraList_tRunJob_4.add("--context_param nom_onglet="
									+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
						}
						...
						if (childJob_tRunJob_4.getErrorCode() != null
							...
							throw new RuntimeException("Child job running failed.\n"
									+ childJob_tRunJob_4.getException().getClass().getName() + ": "
					...
					String update_tDBOutput_1 = "UPDATE `" + "vente"
							+ "` SET `id_produit` = ?,`id_magasin` = ?,`id_devise` = ?,`id_date` = ?,`id_indicateur` = ?,`reel` = ?,`objectif` = ? WHERE `id_produit` = ? AND `id_magasin` = ? AND `id_date` = ? AND `id_indicateur` = ?";
					...
					String insert_tDBOutput_1 = "INSERT INTO `" + "vente"
							+ "` (`id_produit`,`id_magasin`,`id_devise`,`id_date`,`id_indicateur`,`reel`,`objectif`) VALUES (?,?,?,?,?,?,?)";
...
// ###############################
					...
					Object source_tFileInputExcel_1 = ((String) globalMap.get("tFileList_3_CURRENT_FILEDIRECTORY"))
							+ System.getProperty("file.separator")
							+ ((String) globalMap.get("tFileList_3_CURRENT_FILE"));
...
//end%>
								...
								for (int i = 0; i < tempRowLength_tFileInputExcel_1; i++) {
									...
									if (i + start_column_tFileInputExcel_1 < actual_end_column_tFileInputExcel_1) {
										...
										if (jxl.CellType.NUMBER == cell_tFileInputExcel_1.getType()
												|| jxl.CellType.NUMBER_FORMULA == cell_tFileInputExcel_1.getType()) {
											double doubleCell_tFileInputExcel_1 = ((jxl.NumberCell) cell_tFileInputExcel_1)
													.getValue();
											temp_row_tFileInputExcel_1[i] = String
													.valueOf(doubleCell_tFileInputExcel_1);
											if (temp_row_tFileInputExcel_1[i] != null) {
												temp_row_tFileInputExcel_1[i] = df_tFileInputExcel_1
														.format(doubleCell_tFileInputExcel_1);
											}
										} else if (jxl.CellType.DATE == cell_tFileInputExcel_1.getType()
								...
								try {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Fevrier = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Mars = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.CA_Mars = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.MB_Mars = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Avril = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.CA_Avril = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.MB_Avril = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Mai = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.CA_Mai = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.MB_Mai = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Juin = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.CA_Juin = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.MB_Juin = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Juillet = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Aout = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.CA_Aout = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.MB_Aout = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
										row1.V_Octobre = null;
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.V_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.CA_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
										...
										row1.MB_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), ',',
												'.'));
									} else {
...
// Start of branch "row1"
								if (row1 != null) {
									 ...
									 */
									String[] pivotKeysArray = { "V_Janvier", "CA_Janvier", "MB_Janvier", "V_Fevrier",
											"CA_Fevrier", "MB_Fevrier", "V_Mars", "CA_Mars", "MB_Mars", "V_Avril",
											"CA_Avril", "MB_Avril", "V_Mai", "CA_Mai", "MB_Mai", "V_Juin", "CA_Juin",
											"MB_Juin", "V_Juillet", "CA_Juillet", "MB_Juillet", "V_Aout", "CA_Aout",
											"MB_Aout", "V_Septembre", "CA_Septembre", "MB_Septembre", "V_Octobre",
											"CA_Octobre", "MB_Octobre", "V_Novembre", "CA_Novembre", "MB_Novembre",
									...
									for (String field : pivotKeysArray) {
										...
										try {
											row6.pivot_value = row1.getClass().getDeclaredField(field).get(row1)
													.toString();
										} catch (Exception e) {
										...
										if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
											...
											row2HashKey.type_produit = ((String) globalMap
										...
										if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G
											...
											// 'row2' and it contains more one result from keys : row2.type_produit = '"
											// + row2HashKey.type_produit + "'");
										} // G 071
										...
										if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G
											...
											// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
											// 'row3' and it contains more one result from keys : row3.datetime = '" +
											// row3HashKey.datetime + "'");
										} // G 071
										...
										if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G
											...
											// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
											// 'row4' and it contains more one result from keys : row4.ville = '" +
											// row4HashKey.ville + "'");
										} // G 071
										...
										if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G
											...
											// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
											// 'row5' and it contains more one result from keys : row5.abbreviation = '"
											// + row5HashKey.abbreviation + "'");
										} // G 071
...
// Start of branch "ventes"
											if (ventes != null) {
												...
												if (ventes.objectif == null) {
													...
													pstmtUpdate_tDBOutput_1.setFloat(7, ventes.objectif);
												}
												...
												try {
													...
													if (updateFlag_tDBOutput_1 == 0) {
														...
														if (ventes.objectif == null) {
															...
															pstmtInsert_tDBOutput_1.setFloat(7, ventes.objectif);
														}
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tMap_3 - inputs:(row13,row8)
				// outputs:(noms_colonnes,noms_colonnes) | target
				// node:tAdvancedHash_noms_colonnes - inputs:(noms_colonnes) outputs:()
				// linked node: tMap_1 - inputs:(noms_colonnes,row11)
				// outputs:(colonnes_en_ligne_unique)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_noms_colonnes = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.ALL_ROWS;
...
// # Output table : 'noms_colonnes'
							noms_colonnes_tmp.colonne = String.format("%s_%s", row13.abbreviation,
									Var.liste_mois.get(row8.idx_mois));
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integration_objectif.class.getClassLoader()
					.getResourceAsStream("projetbi/integration_objectif_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = integration_objectif.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : integration_objectif");
		}
...
/************************************************************************************************
 * 400389 characters generated by Talend Open Studio for Data Integration on the
 * 2 mai 2019 22:50:05 CEST
 ************************************************************************************************/