...
package projetbi.integration_objectif_0_1;
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_PROJETBI_integration_objectif = new byte[0];
    static byte[] commonByteArray_PROJETBI_integration_objectif = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_integration_objectif.length) {
				if(length < 1024 && commonByteArray_PROJETBI_integration_objectif.length == 0) {
   					commonByteArray_PROJETBI_integration_objectif = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_integration_objectif = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_integration_objectif, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_integration_objectif, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_integration_objectif) {
 ...
 */
	...
	NB_ITERATE_tDBInput_5++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate5", 1, "exec" + NB_ITERATE_tDBInput_5);
					//Thread.sleep(1000);
				}				
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		projetbi.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets childJob_tRunJob_2 = new projetbi.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets();
	    // pass DataSources
 ...
 */
						...
						if(execStat){
							runStat.updateStatOnConnection("iterate5", 2, "exec" + NB_ITERATE_tDBInput_5);
						}				
	...
	NB_ITERATE_tFileExcelWorkbookOpen_2++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate6", 1, "exec" + NB_ITERATE_tFileExcelWorkbookOpen_2);
					//Thread.sleep(1000);
				}				
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "Villes,"+row12.colonne;
		if(obj_tRunJob_4!=null) {
		...
		projetbi.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes childJob_tRunJob_4 = new projetbi.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes();
	    // pass DataSources
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate6", 2, "exec" + NB_ITERATE_tFileExcelWorkbookOpen_2);
						}				
...
String tableName_tDBOutput_2 = "vente";
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "vente" + "` SET `id_produit` = ?,`id_magasin` = ?,`id_devise` = ?,`id_date` = ?,`id_indicateur` = ?,`objectif` = ? WHERE `id_produit` = ? AND `id_magasin` = ? AND `id_date` = ? AND `id_indicateur` = ?";
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO `" + "vente" + "` (`id_produit`,`id_magasin`,`id_devise`,`id_date`,`id_indicateur`,`objectif`) VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
    		...
    		row1 = null;
					int tempRowLength_tFileInputExcel_1 = 37;
...
*/
	String[] pivotKeysArray = {"V_Janvier","CA_Janvier","MB_Janvier","V_Fevrier","CA_Fevrier","MB_Fevrier","V_Mars","CA_Mars","MB_Mars","V_Avril","CA_Avril","MB_Avril","V_Mai","CA_Mai","MB_Mai","V_Juin","CA_Juin","MB_Juin","V_Juillet","CA_Juillet","MB_Juillet","V_Aout","CA_Aout","MB_Aout","V_Septembre","CA_Septembre","MB_Septembre","V_Octobre","CA_Octobre","MB_Octobre","V_Novembre","CA_Novembre","MB_Novembre","V_Decembre","CA_Decembre","MB_Decembre"};
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
            int updateFlag_tDBOutput_2=0;
                    pstmtUpdate_tDBOutput_2.setInt(1, ventes.id_produit);

                    pstmtUpdate_tDBOutput_2.setInt(2, ventes.id_magasin);

                    pstmtUpdate_tDBOutput_2.setInt(3, ventes.id_devise);

                    pstmtUpdate_tDBOutput_2.setInt(4, ventes.id_date);

                    pstmtUpdate_tDBOutput_2.setInt(5, ventes.id_indicateur);

                    if(ventes.objectif == null) {
pstmtUpdate_tDBOutput_2.setNull(6, java.sql.Types.FLOAT);
} else {pstmtUpdate_tDBOutput_2.setFloat(6, ventes.objectif);
}


                    pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, ventes.id_produit);


                    pstmtUpdate_tDBOutput_2.setInt(8 + count_tDBOutput_2, ventes.id_magasin);


                    pstmtUpdate_tDBOutput_2.setInt(9 + count_tDBOutput_2, ventes.id_date);


                    pstmtUpdate_tDBOutput_2.setInt(10 + count_tDBOutput_2, ventes.id_indicateur);
            ...
            if(updateFlag_tDBOutput_2 == 0) {
                        ...
                        pstmtInsert_tDBOutput_2.setInt(1, ventes.id_produit);

                        pstmtInsert_tDBOutput_2.setInt(2, ventes.id_magasin);

                        pstmtInsert_tDBOutput_2.setInt(3, ventes.id_devise);

                        pstmtInsert_tDBOutput_2.setInt(4, ventes.id_date);

                        pstmtInsert_tDBOutput_2.setInt(5, ventes.id_indicateur);

                        if(ventes.objectif == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_2.setFloat(6, ventes.objectif);
}
...
Var.liste_mois = projetBi.getNormalizedMonthList();// ###############################
        // ###############################
        // # Output tables
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row6,row2,row3,row4,row5) outputs:(ventes)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integration_objectif.class.getClassLoader().getResourceAsStream("projetbi/integration_objectif_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     386744 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 avril 2019 22:34:41 CEST
 ************************************************************************************************/