...
package projet_bi_3.controle_qualite_reel_0_1;
...
public class controle_qualite_reel implements TalendJob {
	...
	public static class ventesStruct implements routines.system.IPersistableRow<ventesStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_3_controle_qualite_reel = new byte[0];
		static byte[] commonByteArray_PROJET_BI_3_controle_qualite_reel = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_3_controle_qualite_reel.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_3_controle_qualite_reel.length == 0) {
						commonByteArray_PROJET_BI_3_controle_qualite_reel = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_3_controle_qualite_reel = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_3_controle_qualite_reel, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_3_controle_qualite_reel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_3_controle_qualite_reel) {
...
// Start of branch "ventes"
											if (ventes != null) {
												...
												if (ventes.reel < 0 || ventes.reel == null) {
													throw new Exception(
															"Un chiffre négative ou une case vide a été trouvé dans le fichier: '"
																	+ context.nom_fichier
																	+ "'. Veuillez corriger le fichier : *_yyyy.xls. Ville="
																	+ ventes.ville + ", indicateur="
																	+ ventes.abreviation + ",produit="
																	+ ventes.type_produit);
												}
...
// Start of branch "vente_not_found"
											if (vente_not_found != null) {
												...
												if (true) {
													throw new Exception(
															"Une ou plusieurs ligne n'a(ont) pas pu être insérée(s) car aucun augun magasin n'est la(les) ville(s) spécifié dans le fichier: '"
																	+ context.nom_fichier
																	+ "'. Veuillez corriger le fichier. Ville="
																	+ vente_not_found.ville);
												}
												nb_line_tJavaRow_2++;
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row6,row2,row3,row4,row12,row5)
				// outputs:(ventes,vente_not_found)
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_4 - inputs:(after_tFileList_1) outputs:(row12,row12) |
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = controle_qualite_reel.class.getClassLoader().getResourceAsStream(
					"projet_bi_3/controle_qualite_reel_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = controle_qualite_reel.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : controle_qualite_reel");
		}
...
/************************************************************************************************
 * 258977 characters generated by Talend Open Studio for Data Integration on the
 * 23 mai 2019 19:50:13 CEST
 ************************************************************************************************/