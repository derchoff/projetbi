...
package projetbi.controle_qualite_reel_0_1;
...
public static class ventesStruct implements routines.system.IPersistableRow<ventesStruct> {
    final static byte[] commonByteArrayLock_PROJETBI_controle_qualite_reel = new byte[0];
    static byte[] commonByteArray_PROJETBI_controle_qualite_reel = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_controle_qualite_reel) {
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_controle_qualite_reel.length) {
				if(length < 1024 && commonByteArray_PROJETBI_controle_qualite_reel.length == 0) {
   					commonByteArray_PROJETBI_controle_qualite_reel = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_controle_qualite_reel = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_controle_qualite_reel, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_controle_qualite_reel, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if(ventes != null) { 
	...
	throw new Exception("Un chiffre négative ou une case vide a été trouvé dans le fichier: '"+  context.nom_fichier +"'. Veuillez corriger le fichier : *_yyyy.xls.");
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = controle_qualite_reel.class.getClassLoader().getResourceAsStream("projetbi/controle_qualite_reel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     254987 characters generated by Talend Open Studio for Data Integration 
