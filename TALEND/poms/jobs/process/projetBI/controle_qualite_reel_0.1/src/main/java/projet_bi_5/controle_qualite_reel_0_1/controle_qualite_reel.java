...
package projet_bi_5.controle_qualite_reel_0_1;
...
public static class ventesStruct implements routines.system.IPersistableRow<ventesStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_controle_qualite_reel = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_controle_qualite_reel = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_controle_qualite_reel.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_controle_qualite_reel.length == 0) {
   					commonByteArray_PROJET_BI_5_controle_qualite_reel = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_controle_qualite_reel = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_controle_qualite_reel, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_controle_qualite_reel, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_controle_qualite_reel) {
...
ventes_tmp.reel = Float.parseFloat(row8.pivot_value) ;
...
vente_not_found_tmp.reel = Float.parseFloat(row8.pivot_value);
vente_not_found_tmp.objectif = null;
vente_not_found_tmp.Code_postal = row8.Code_postal ;
...
if(vente_not_found != null) { 
    ...
    if(true){
	throw new Exception("Une ou plusieurs ligne n'a(ont) pas pu être insérée(s) car le magasin n'est associé à acune ville enregistré dans la base : '"+  context.nom_fichier +"'. Veuillez corriger le fichier. Code postal=" + vente_not_found.Code_postal);
}
    nb_line_tJavaRow_2++;   
...
//end%>
			...
			row7.CA_Juin = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim();
			}else {
				row7.CA_Juin = null;
				emptyColumnCount_tFileInputExcel_2++;
		}
			...
			row7.MB_Juin = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim();
			}else {
				row7.MB_Juin = null;
				emptyColumnCount_tFileInputExcel_2++;
		}
			...
			row7.V_Juin = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim();
			}else {
				row7.V_Juin = null;
				emptyColumnCount_tFileInputExcel_2++;
		}

        if(emptyColumnCount_tFileInputExcel_2 >= 5){
        	break; //if meet the empty row, there will break the iterate.
        }
...
// # Output table : 'out'
out_tmp.Villes = row7.Villes ;
out_tmp.Code_postal = row7.Code_postal ;
out_tmp.CA_Juin = Float.parseFloat(row7.CA_Juin);
out_tmp.MB_Juin = Float.parseFloat(row7.MB_Juin);
out_tmp.V_Juin = Float.parseFloat(row7.V_Juin);
out = out_tmp;
// ###############################
...
if(out != null) { 
    ...
    //vérification si CA==0 alors tous les autres doivent être à zéro
if (out.CA_Juin == 0 && (out.MB_Juin != 0 || out.V_Juin != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour la ville '" + out.Villes + "', pour le produit '" + ((String)globalMap.get("tFileInputExcel_2_CURRENT_SHEET")) + "'. Veuillez corriger le fichier : CA est à zéro mais la vente et la marge brute sont > 0.");
}

//la marge brute peut être égale à zéro, elle est donc signalé comme un warning seulement.

//vérification si V ==0 alors tous les autres doivent être à zéro
if (out.V_Juin == 0 && (out.MB_Juin != 0 || out.CA_Juin != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour la ville '" + out.Villes + "', pour le produit '" + ((String)globalMap.get("tFileInputExcel_2_CURRENT_SHEET")) + "'. Veuillez corriger le fichier : Vente est à zéro mais le CA et la MB sont > 0.");
}

//ventes ne peut pas être une fraction
float ctrl_qual_ventes = out.V_Juin * 1000.0f;
if (ctrl_qual_ventes-Math.floor(ctrl_qual_ventes) != 0 ) {
	throw new Exception("les ventes de la ville " + out.Villes + ", pour le produit " + ((String)globalMap.get("tFileInputExcel_2_CURRENT_SHEET")) + " ont des valeurs décimales une fois converties en millier");
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row8,row2,row3,row4,row12,row5) outputs:(ventes,vente_not_found)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = controle_qualite_reel.class.getClassLoader().getResourceAsStream("projet_bi_5/controle_qualite_reel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     278673 characters generated by Talend Open Studio for Data Integration 
