...
package projetbi.gestion_dossier_avertissement_0_1;
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PROJETBI_gestion_dossier_avertissement = new byte[0];
    static byte[] commonByteArray_PROJETBI_gestion_dossier_avertissement = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_gestion_dossier_avertissement.length) {
				if(length < 1024 && commonByteArray_PROJETBI_gestion_dossier_avertissement.length == 0) {
   					commonByteArray_PROJETBI_gestion_dossier_avertissement = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_gestion_dossier_avertissement = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_gestion_dossier_avertissement, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_gestion_dossier_avertissement, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_gestion_dossier_avertissement) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.excel_output_warning_repository + TalendDate.getDate("YYYY-MM-dd")+"/" + TalendDate.getDate("YYYY-MM-dd") + ".log")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String srcFileName_tFileCopy_1 = context.excel_input_repository + context.nom_fichier;
        ...
        String desDirName_tFileCopy_1 = context.excel_output_warning_repository + TalendDate.getDate("YYYY-MM-dd")+"/";
		...
		if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())  ) {           
				...
				java.io.File isRemoved_tFileCopy_1 = new java.io.File(context.excel_input_repository + context.nom_fichier);
 ...
 */
    ...
    String subject_tSendMail_1 = ("Avertissement d'integration");
	...
	String message_tSendMail_1 = (("Message d'avertissement: " + String.valueOf(row3.MessageAvertissement)) == null || "".equals("Message d'avertissement: " + String.valueOf(row3.MessageAvertissement))) ? "\"\"" : ("Message d'avertissement: " + String.valueOf(row3.MessageAvertissement)) ;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gestion_dossier_avertissement.class.getClassLoader().getResourceAsStream("projetbi/gestion_dossier_avertissement_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     132954 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 mai 2019 17:30:50 SBT
 ************************************************************************************************/