...
package projet_bi_5.dimension_indicateurs_0_1;
...
public static class efface_indicateurStruct implements routines.system.IPersistableRow<efface_indicateurStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_dimension_indicateurs = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_dimension_indicateurs = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_dimension_indicateurs.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_dimension_indicateurs.length == 0) {
   					commonByteArray_PROJET_BI_5_dimension_indicateurs = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_dimension_indicateurs = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_dimension_indicateurs, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_dimension_indicateurs, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_dimension_indicateurs) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_indicateurs.class.getClassLoader().getResourceAsStream("projet_bi_5/dimension_indicateurs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
