...
package projet_bi_4.verification_du_nom_des_onglets_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_4_verification_du_nom_des_onglets = new byte[0];
    static byte[] commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets.length == 0) {
   					commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_4_verification_du_nom_des_onglets, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_4_verification_du_nom_des_onglets) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = verification_du_nom_des_onglets.class.getClassLoader().getResourceAsStream("projet_bi_4/verification_du_nom_des_onglets_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     105494 characters generated by Talend Open Studio for Data Integration 
 *     on the 19 juin 2019 01:48:53 CEST
 ************************************************************************************************/