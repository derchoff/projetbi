...
package projet_bi_5.integration_magasins_0_1;
...
public static class efface_magasinStruct implements routines.system.IPersistableRow<efface_magasinStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_magasins = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_magasins = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_integration_magasins) {
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_integration_magasins.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_integration_magasins.length == 0) {
   					commonByteArray_PROJET_BI_5_integration_magasins = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_integration_magasins = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_integration_magasins, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_integration_magasins, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public static class magin_recordStruct implements routines.system.IPersistableRow<magin_recordStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final magin_recordStruct other = (magin_recordStruct) obj;
	...
	public void copyDataTo(magin_recordStruct other) {
	...
	public void copyKeysDataTo(magin_recordStruct other) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_integration_magasins) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.id_departement = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.id_departement);
    ...
    public String toString() {
		...
		sb.append(",ville="+ville);
		sb.append(",code_postal="+code_postal);
		sb.append(",id_departement="+String.valueOf(id_departement));
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(magin_recordStruct other) {
...
public static class villes_corrigeeStruct implements routines.system.IPersistableRow<villes_corrigeeStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_magasins = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_magasins = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(villes_corrigeeStruct other) {
...
public static class vStruct implements routines.system.IPersistableRow<vStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final vStruct other = (vStruct) obj;
	...
	public void copyDataTo(vStruct other) {
	...
	public void copyKeysDataTo(vStruct other) {
...
public static class after_tFileList_2Struct implements routines.system.IPersistableRow<after_tFileList_2Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_magasins = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_magasins = new byte[0];
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projet_bi_5.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets childJob_tRunJob_3 = new projet_bi_5.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "Villes,Code postal,Enseignes,Region,Responsable_Magasin,Directeur_Regional,Directeur_Commercial";
		if(obj_tRunJob_2!=null) {
		...
		projet_bi_5.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes childJob_tRunJob_2 = new projet_bi_5.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes();
	    // pass DataSources
	...
	currentComponent="tDBOutput_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("magin_record" + iterateId, 0, 0);
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "magasin" + "` SET `id_region` = ?,`enseigne` = ?,`ville` = ?,`code_postal` = ?,`id_departement` = ? WHERE `code_postal` = ?";
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO `" + "magasin" + "` (`id_region`,`enseigne`,`ville`,`code_postal`,`id_departement`) VALUES (?,?,?,?,?)";
	...
	currentComponent="tMap_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("villes_corrigee" + iterateId, 0, 0);
...
// ###############################
// # Outputs initialization
villes_corrigeeStruct villes_corrigee_tmp = new villes_corrigeeStruct();
// ###############################
...
villes_corrigee = null;


// # Output table : 'villes_corrigee'
villes_corrigee_tmp.Villes = StringHandling.CHANGE(StringHandling.CHANGE(row1.Villes, "St_", "Saint-"), "_", "-") ;
villes_corrigee_tmp.Code_postal = StringHandling.LPAD(row1.Code_postal, 5, "0") ;
villes_corrigee_tmp.Enseignes = row1.Enseignes ;
villes_corrigee_tmp.Region = row1.Region ;
villes_corrigee = villes_corrigee_tmp;
// ###############################
 ...
 */
// Start of branch "villes_corrigee"
if(villes_corrigee != null) { 
	...
	currentComponent="tMap_2";
			...
			//villes_corrigee
				...
				if(execStat){
					runStat.updateStatOnConnection("villes_corrigee"+iterateId,1, 1);
				} 
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row5HashKey.zip_code = villes_corrigee.Code_postal ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.zip_code = '" + row5HashKey.zip_code + "'");
								} // G 071
...
// # Filter conditions 
if( rejected_tMap_2 ) {
magasins_tmp.enseigne = villes_corrigee.Enseignes ;
magasins_tmp.ville = villes_corrigee.Villes ;
magasins_tmp.code_postal = villes_corrigee.Code_postal ;
magasins_tmp.code_departement = row5.department_code ;
magasins_tmp.Region = villes_corrigee.Region ;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
								  ...
								  if(!tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.slug = '" + row4HashKey.slug + "'");
								} // G 071
...
if(magin_record != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			//magin_record
				...
				if(execStat){
					runStat.updateStatOnConnection("magin_record"+iterateId,1, 1);
				} 
        ...
        whetherReject_tDBOutput_2 = false;
            int updateFlag_tDBOutput_2=0;
                    pstmtUpdate_tDBOutput_2.setInt(1, magin_record.id_region);

                    if(magin_record.enseigne == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, magin_record.enseigne);
}

                    if(magin_record.ville == null) {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(3, magin_record.ville);
}

                    if(magin_record.code_postal == null) {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(4, magin_record.code_postal);
}

                    pstmtUpdate_tDBOutput_2.setInt(5, magin_record.id_departement);


                    if(magin_record.code_postal == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, magin_record.code_postal);
}
            ...
            if(updateFlag_tDBOutput_2 == 0) {
                        ...
                        pstmtInsert_tDBOutput_2.setInt(1, magin_record.id_region);

                        if(magin_record.enseigne == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, magin_record.enseigne);
}

                        if(magin_record.ville == null) {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(3, magin_record.ville);
}

                        if(magin_record.code_postal == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, magin_record.code_postal);
}

                        pstmtInsert_tDBOutput_2.setInt(5, magin_record.id_departement);
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("villes_corrigee"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("magin_record"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	NB_ITERATE_tFileInputExcel_2++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("v", 3, 0);
					}           			
	...
	currentComponent="tAdvancedHash_row9";
		...
		int tos_count_tAdvancedHash_row9 = 0;
			   		...
			   		// source node:tUniqRow_1 - inputs:(v) outputs:(row9,row9) | target node:tAdvancedHash_row9 - inputs:(row9) outputs:()
	...
	currentComponent="tUniqRow_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("v" + iterateId, 0, 0);
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
    		...
    		row2 = null;
					int tempRowLength_tFileInputExcel_2 = 7;
...
// # Output table : 'v'
v_tmp.Villes = StringHandling.CHANGE(StringHandling.CHANGE(row2.Villes, "St_", "Saint-"), "_", "-") ;
v_tmp.Code_Postal = StringHandling.LPAD(row2.Code_postal, 5, "0") ;
v = v_tmp;
// ###############################
...
if(v != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			//v
				...
				if(execStat){
					runStat.updateStatOnConnection("v"+iterateId,1, 1);
				} 
...
if(v.Villes == null){
	...
	finder_tUniqRow_1.Villes = v.Villes.toLowerCase();
}
if(v.Code_Postal == null){
	finder_tUniqRow_1.Code_Postal = null;
}else{
	finder_tUniqRow_1.Code_Postal = v.Code_Postal.toLowerCase();
}	
...
if(v.Villes == null){
	...
	new_tUniqRow_1.Villes = v.Villes.toLowerCase();
}
if(v.Code_Postal == null){
	new_tUniqRow_1.Code_Postal = null;
}else{
	new_tUniqRow_1.Code_Postal = v.Code_Postal.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row9 == null){ 
	
	row9 = new row9Struct();
}row9.Villes = v.Villes;			row9.Code_Postal = v.Code_Postal;			if(row9 == null){ 
	
	row9 = new row9Struct();
}row9.Villes = v.Villes;			row9.Code_Postal = v.Code_Postal;					
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("v"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = ((String)globalMap.get("tFileList_2_CURRENT_FILE"));
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.zip_code == null) ? 0 : this.zip_code.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						} else if (!this.zip_code.equals(other.zip_code))
	...
	public void copyDataTo(row5Struct other) {
		...
		other.id = this.id;
	            ...
	            other.insee_code = this.insee_code;
	            other.zip_code = this.zip_code;
	            other.name = this.name;
	            other.slug = this.slug;
	            other.gps_lat = this.gps_lat;
	            other.gps_lng = this.gps_lng;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.department_code = readString(dis,ois);
					
						this.insee_code = readString(dis,ois);
					
						this.name = readString(dis,ois);
					
						this.slug = readString(dis,ois);
					
			            this.gps_lat = dis.readDouble();
					
			            this.gps_lng = dis.readDouble();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.department_code, dos, oos);
					
						writeString(this.insee_code, dos, oos);
					
						writeString(this.name, dos, oos);
					
						writeString(this.slug, dos, oos);
					
		            	dos.writeDouble(this.gps_lat);
					
		            	dos.writeDouble(this.gps_lng);
    ...
    public String toString() {
		...
		sb.append(",insee_code="+insee_code);
		sb.append(",zip_code="+zip_code);
		sb.append(",name="+name);
		sb.append(",slug="+slug);
		sb.append(",gps_lat="+String.valueOf(gps_lat));
		sb.append(",gps_lng="+String.valueOf(gps_lng));
	    sb.append("]");
...
+"name`, \n  `cities`.`slug`, \n  `cities`.`gps_lat`, \n  `cities`.`gps_lng`\nFROM `cities`";
            ...
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_4 < 2) {
								row5.department_code = null;
							} else {
	                         		
        	row5.department_code = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row5.insee_code = null;
							} else {
	                         		
        	row5.insee_code = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row5.zip_code = null;
							} else {
	                         		
        	row5.zip_code = routines.system.JDBCUtil.getString(rs_tDBInput_4, 4, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row5.name = null;
							} else {
	                         		
        	row5.name = routines.system.JDBCUtil.getString(rs_tDBInput_4, 5, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 6) {
								row5.slug = null;
							} else {
	                         		
        	row5.slug = routines.system.JDBCUtil.getString(rs_tDBInput_4, 6, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 7) {
								row5.gps_lat = 0;
							} else {
	                         		
            row5.gps_lat = rs_tDBInput_4.getDouble(7);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row5.gps_lng = rs_tDBInput_4.getDouble(8);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			//row5
				...
				row5_HashRow.department_code = row5.department_code;
				
				row5_HashRow.insee_code = row5.insee_code;
				
				row5_HashRow.zip_code = row5.zip_code;
				
				row5_HashRow.name = row5.name;
				
				row5_HashRow.slug = row5.slug;
				
				row5_HashRow.gps_lat = row5.gps_lat;
				
				row5_HashRow.gps_lng = row5.gps_lng;
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.db_pwd; 
        	...
        	row3.code = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.slug, other.slug);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.db_pwd; 
        	...
        	row4.slug = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integration_magasins.class.getClassLoader().getResourceAsStream("projet_bi_5/integration_magasins_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
