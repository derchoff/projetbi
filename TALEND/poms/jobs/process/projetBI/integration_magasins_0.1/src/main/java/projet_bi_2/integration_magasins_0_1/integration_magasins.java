...
package projet_bi_2.integration_magasins_0_1;
...
public class integration_magasins implements TalendJob {
	...
	public static class efface_magasinStruct implements routines.system.IPersistableRow<efface_magasinStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_2_integration_magasins = new byte[0];
		static byte[] commonByteArray_PROJET_BI_2_integration_magasins = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_2_integration_magasins) {
	...
	public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_2_integration_magasins.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_2_integration_magasins.length == 0) {
						commonByteArray_PROJET_BI_2_integration_magasins = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_2_integration_magasins = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_2_integration_magasins, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_2_integration_magasins, 0, length, utf8Charset);
			}
			return strReturn;
		}
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row9 != null && tHash_Lookup_row9.getCount(row9HashKey) > 1) { // G 071
							...
							// row9HashKey.Villes + "', row9.Code_Postal = '" + row9HashKey.Code_Postal +
							// "'");
						} // G 071
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_2 - inputs:(after_tFileList_2) outputs:(row4,row4) |
				// target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
				// linked node: tMap_4 - inputs:(row4,row3,magasins) outputs:(magin_record)
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_3 - inputs:(after_tFileList_2) outputs:(row3,row3) |
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_4 - inputs:(after_tFileList_2) outputs:(row5,row5) |
				// target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
				// linked node: tMap_2 - inputs:(row5,villes_corrigee) outputs:(magasins)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
					...
					projet_bi_2.verification_annee_fichier_0_1.verification_annee_fichier childJob_tRunJob_1 = new projet_bi_2.verification_annee_fichier_0_1.verification_annee_fichier();
					// pass DataSources
					...
					projet_bi_2.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets childJob_tRunJob_3 = new projet_bi_2.verification_du_nom_des_onglets_0_1.verification_du_nom_des_onglets();
					// pass DataSources
					...
					projet_bi_2.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes childJob_tRunJob_2 = new projet_bi_2.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes();
					// pass DataSources
					...
					String update_tDBOutput_2 = "UPDATE `" + "magasin"
							+ "` SET `enseigne` = ?,`ville` = ?,`code_postal` = ?,`id_departement` = ? WHERE `code_postal` = ?";
					...
					String insert_tDBOutput_2 = "INSERT INTO `" + "magasin"
							+ "` (`enseigne`,`ville`,`code_postal`,`id_departement`) VALUES (?,?,?,?)";
...
// # Output table : 'villes_corrigee'
										villes_corrigee_tmp.Villes = StringHandling
												.CHANGE(StringHandling.CHANGE(row1.Villes, "St_", "Saint-"), "_", "-");
...
// Start of branch "villes_corrigee"
									if (villes_corrigee != null) {
										...
										if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G
											...
											// 'row5' and it contains more one result from keys : row5.zip_code = '" +
											// row5HashKey.zip_code + "'");
										} // G 071
...
// Start of branch "magasins"
										if (magasins != null) {
											...
											if (tHash_Lookup_row3 != null
													&& tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071

												// System.out.println("WARNING: UNIQUE MATCH is configured for the
												// lookup 'row3' and it contains more one result from keys : row3.code =
												// '" + row3HashKey.code + "'");
											} // G 071
											...
											if (tHash_Lookup_row4 != null
												...
												// System.out.println("WARNING: UNIQUE MATCH is configured for the
												// lookup 'row4' and it contains more one result from keys : row4.slug =
												// '" + row4HashKey.slug + "'");
											} // G 071
...
// Start of branch "magin_record"
											if (magin_record != null) {
												...
												if (magin_record.enseigne == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(1, magin_record.enseigne);
												}

												if (magin_record.ville == null) {
													pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_2.setString(2, magin_record.ville);
												}

												if (magin_record.code_postal == null) {
													pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_2.setString(3, magin_record.code_postal);
												}

												pstmtUpdate_tDBOutput_2.setInt(4, magin_record.id_departement);

												if (magin_record.code_postal == null) {
													pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2,
															magin_record.code_postal);
												}
												...
												try {
													...
													if (updateFlag_tDBOutput_2 == 0) {
														...
														if (magin_record.enseigne == null) {
															...
															pstmtInsert_tDBOutput_2.setString(1, magin_record.enseigne);
														}

														if (magin_record.ville == null) {
															pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
														} else {
															pstmtInsert_tDBOutput_2.setString(2, magin_record.ville);
														}
														...
														pstmtInsert_tDBOutput_2.setInt(4, magin_record.id_departement);
...
// ###############################      
					...
					// source node:tUniqRow_1 - inputs:(v) outputs:(row9,row9) | target
					...
					class KeyStruct_tUniqRow_1 {
						...
						public int hashCode() {
							if (this.hashCodeDirty) {
								...
								result = prime * result
										+ ((this.Code_Postal == null) ? 0 : this.Code_Postal.hashCode());
...
// # Output table : 'v'
										v_tmp.Villes = StringHandling
												.CHANGE(StringHandling.CHANGE(row2.Villes, "St_", "Saint-"), "_", "-");
...
// Start of branch "v"
									if (v != null) {
										...
										if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
											...
											row9.Villes = v.Villes;
											row9.Code_Postal = v.Code_Postal;
											if (row9 == null) {
...
// ###############################      
					...
					if (obj_tRunJob_4 != null) {
						paraList_tRunJob_4.add(
								"--context_param nom_job_talend=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
					} else {
						paraList_tRunJob_4.add("--context_param nom_job_talend="
								+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_4.put("nom_job_talend", obj_tRunJob_4);

					projet_bi_2.gestion_dossier_reussi_0_1.gestion_dossier_reussi childJob_tRunJob_4 = new projet_bi_2.gestion_dossier_reussi_0_1.gestion_dossier_reussi();
					// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integration_magasins.class.getClassLoader()
					.getResourceAsStream("projet_bi_2/integration_magasins_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 313936 characters generated by Talend Open Studio for Data Integration on the
 * 23 mai 2019 18:06:38 CEST
 ************************************************************************************************/