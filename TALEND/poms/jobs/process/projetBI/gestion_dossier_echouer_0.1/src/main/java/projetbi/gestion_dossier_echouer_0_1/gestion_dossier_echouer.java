...
package projetbi.gestion_dossier_echouer_0_1;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJETBI_gestion_dossier_echouer = new byte[0];
    static byte[] commonByteArray_PROJETBI_gestion_dossier_echouer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_gestion_dossier_echouer.length) {
				if(length < 1024 && commonByteArray_PROJETBI_gestion_dossier_echouer.length == 0) {
   					commonByteArray_PROJETBI_gestion_dossier_echouer = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_gestion_dossier_echouer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_gestion_dossier_echouer, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_gestion_dossier_echouer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_gestion_dossier_echouer) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.excel_output_erreur_repository + TalendDate.getDate("YYYY-MM-dd")+"/" + TalendDate.getDate("YYYY-MM-dd") + ".log")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String desDirName_tFileCopy_1 = context.excel_output_erreur_repository + TalendDate.getDate("YYYY-MM-dd")+"/";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gestion_dossier_echouer.class.getClassLoader().getResourceAsStream("projetbi/gestion_dossier_echouer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     115627 characters generated by Talend Open Studio for Data Integration 
