...
package projet_bi_5.gestion_dossier_echouer_0_1;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_gestion_dossier_echouer = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_gestion_dossier_echouer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_gestion_dossier_echouer.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_gestion_dossier_echouer.length == 0) {
   					commonByteArray_PROJET_BI_5_gestion_dossier_echouer = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_gestion_dossier_echouer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_gestion_dossier_echouer, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_gestion_dossier_echouer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_gestion_dossier_echouer) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gestion_dossier_echouer.class.getClassLoader().getResourceAsStream("projet_bi_5/gestion_dossier_echouer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
