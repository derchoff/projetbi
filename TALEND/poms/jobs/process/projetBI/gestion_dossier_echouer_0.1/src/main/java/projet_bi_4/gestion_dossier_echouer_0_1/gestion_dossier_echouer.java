...
package projet_bi_4.gestion_dossier_echouer_0_1;
...
/**
 * Job: gestion_dossier_echouer Purpose: Deplacement fichier et logs fichier des intégrations échoué<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190325_1906-M4
 * @status 
 */
public class gestion_dossier_echouer implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(log_erreur != null){
					...
					this.setProperty("log_erreur", log_erreur.toString());
...
public String log_erreur;
public String getLog_erreur(){
	return this.log_erreur;
}
	...
	private final String jobName = "gestion_dossier_echouer";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_moHEoHLfEemsls5JCTtTrw", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_moHEoHLfEemsls5JCTtTrw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				gestion_dossier_echouer.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(gestion_dossier_echouer.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_4_gestion_dossier_echouer = new byte[0];
    static byte[] commonByteArray_PROJET_BI_4_gestion_dossier_echouer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_4_gestion_dossier_echouer.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_4_gestion_dossier_echouer.length == 0) {
   					commonByteArray_PROJET_BI_4_gestion_dossier_echouer = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_4_gestion_dossier_echouer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_4_gestion_dossier_echouer, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_4_gestion_dossier_echouer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_4_gestion_dossier_echouer) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.excel_output_erreur_repository +System.getProperty("file.separator") + TalendDate.getDate("YYYY-MM-dd")+System.getProperty("file.separator") + TalendDate.getDate("YYYY-MM-dd") + ".log")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		row1.MessageErreur = context.log_erreur.replaceAll("[\r\n]+", "");
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String desDirName_tFileCopy_1 = context.excel_output_erreur_repository +System.getProperty("file.separator") + TalendDate.getDate("YYYY-MM-dd")+System.getProperty("file.separator");
 ...
 */
    ...
    public static void main(String[] args){
        final gestion_dossier_echouer gestion_dossier_echouerClass = new gestion_dossier_echouer();

        int exitCode = gestion_dossier_echouerClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gestion_dossier_echouer.class.getClassLoader().getResourceAsStream("projet_bi_4/gestion_dossier_echouer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = gestion_dossier_echouer.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("log_erreur", "id_String");
                            context.log_erreur=(String) context.getProperty("log_erreur");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("nom_fichier")) {
            ...
            }if (parentContextMap.containsKey("log_erreur")) {
                context.log_erreur = (String) parentContextMap.get("log_erreur");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : gestion_dossier_echouer");
        }
...
/************************************************************************************************
 *     116198 characters generated by Talend Open Studio for Data Integration 
