...
package projet_bi_3.controle_qualite_objectif_0_1;
...
public class controle_qualite_objectif implements TalendJob {
	...
	private final String projectName = "PROJET_BI_3";
	...
	public static class venteStruct implements routines.system.IPersistableRow<venteStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_3_controle_qualite_objectif = new byte[0];
		static byte[] commonByteArray_PROJET_BI_3_controle_qualite_objectif = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_3_controle_qualite_objectif) {
	...
	public static class vente_output_goodStruct implements routines.system.IPersistableRow<vente_output_goodStruct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_3_controle_qualite_objectif.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_3_controle_qualite_objectif.length == 0) {
						commonByteArray_PROJET_BI_3_controle_qualite_objectif = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_3_controle_qualite_objectif = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_3_controle_qualite_objectif, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_3_controle_qualite_objectif, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ###############################
					...
					Object source_tFileInputExcel_1 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY"))
...
// Start of branch "row1"
								if (row1 != null) {
									 ...
									 */
									String[] pivotKeysArray = { "CA_Janvier", "MB_Janvier", "V_Janvier", "CA_Fevrier",
											"MB_Fevrier", "V_Fevrier", "CA_Mars", "MB_Mars", "V_Mars", "CA_Avril",
											"MB_Avril", "V_Avril", "CA_Mai", "MB_Mai", "V_Mai", "CA_Juin", "MB_Juin",
											"V_Juin", "CA_Juillet", "MB_Juillet", "V_Juillet", "CA_Aout", "MB_Aout",
											"V_Aout", "CA_Septembre", "MB_Septembre", "V_Septembre", "CA_Octobre",
											"MB_Octobre", "V_Octobre", "CA_Novembre", "MB_Novembre", "V_Novembre",
											"CA_Decembre", "MB_Decembre", "V_Decembre" };
...
// Start of branch "vente"
											if (vente != null) {
												...
												if (true) {
													throw new Exception(
															"Une ou plusieurs ligne n'a/ont pas pu être inséré car aucun augun magasins n'est la/les ville(s) spécifié dans le fichier: '"
																	+ context.nom_fichier
...
// Start of branch "vente_output_good"
											if (vente_output_good != null) {
												...
												if (execStat) {
													runStat.updateStatOnConnection("vente_output_good" + iterateId, 1,
															1);
												}

												if (vente_output_good.objectif < 0
														|| vente_output_good.objectif == null) {
													globalMap.put("nom_job_talend", "controle_qualite_objectif");
													throw new Exception(
															"Un chiffre négatif ou une case vide a été trouvé dans le fichier: '"
																	+ context.nom_fichier
																	+ "'. Veuillez corriger le fichier. Ville="
																	+ vente_output_good.ville + ", produit="
																	+ vente_output_good.type_produit + ", indicateur="
																	+ vente_output_good.abreviation);
												}
...
// ###############################      
					...
					Object source_tFileInputExcel_2 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY"))
							+ System.getProperty("file.separator")
							+ ((String) globalMap.get("tFileList_1_CURRENT_FILE"));
						...
						if (sheetList_tFileInputExcel_2.size() > 0) {
							...
							for (int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++) {
								...
								if (rowCount_tFileInputExcel_2 <= i_tFileInputExcel_2
										&& i_tFileInputExcel_2
												- rowCount_tFileInputExcel_2 >= (begin_line_tFileInputExcel_2)
										&& currentRows_tFileInputExcel_2
												- footer_input_tFileInputExcel_2 > i_tFileInputExcel_2
...
//end%>
								...
								for (int i = 0; i < tempRowLength_tFileInputExcel_2; i++) {
									...
									if (i + start_column_tFileInputExcel_2 < actual_end_column_tFileInputExcel_2) {
										...
										if (jxl.CellType.NUMBER == cell_tFileInputExcel_2.getType()
												|| jxl.CellType.NUMBER_FORMULA == cell_tFileInputExcel_2.getType()) {
											double doubleCell_tFileInputExcel_2 = ((jxl.NumberCell) cell_tFileInputExcel_2)
													.getValue();
											temp_row_tFileInputExcel_2[i] = String
													.valueOf(doubleCell_tFileInputExcel_2);
											if (temp_row_tFileInputExcel_2[i] != null) {
												temp_row_tFileInputExcel_2[i] = df_tFileInputExcel_2
														.format(doubleCell_tFileInputExcel_2);
											}
										} else if (jxl.CellType.DATE == cell_tFileInputExcel_2.getType()
												|| jxl.CellType.DATE_FORMULA == cell_tFileInputExcel_2.getType()) {
											...
											temp_row_tFileInputExcel_2[i] = sdf_tFileInputExcel_2
													.format(date_tFileInputExcel_2);
								...
								try {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Janvier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Janvier = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Fevrier = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Fevrier = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.CA_Mars = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.MB_Mars = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Mars = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Mars = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.CA_Avril = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.MB_Avril = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Avril = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Avril = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.CA_Mai = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.MB_Mai = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Mai = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Mai = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.CA_Juin = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.MB_Juin = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Juin = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Juin = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Juillet = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Juillet = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.CA_Aout = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.MB_Aout = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Aout = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Aout = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Septembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Octobre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
										row7.V_Octobre = null;
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Novembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.CA_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.MB_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
									...
									if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim().length() > 0) {
										...
										row7.V_Decembre = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].trim(), ',',
												'.'));
									} else {
...
// Start of branch "row7"
								if (row7 != null) {
									...
									if (row7.CA_Janvier == 0 && (row7.MB_Janvier != 0 || row7.V_Janvier != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Janvier. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Fevrier == 0 && (row7.MB_Fevrier != 0 || row7.V_Fevrier != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Février. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Mars == 0 && (row7.MB_Mars != 0 || row7.V_Mars != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Mars. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Avril == 0 && (row7.MB_Avril != 0 || row7.V_Avril != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois d'Avril. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Mai == 0 && (row7.MB_Mai != 0 || row7.V_Mai != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Mai. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Juin == 0 && (row7.MB_Juin != 0 || row7.V_Juin != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Juin. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Juillet == 0 && (row7.MB_Juillet != 0 || row7.V_Juillet != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Juillet. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Aout == 0 && (row7.MB_Aout != 0 || row7.V_Aout != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois d'Août. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Septembre == 0 && (row7.MB_Septembre != 0 || row7.V_Septembre != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Septembre. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Octobre == 0 && (row7.MB_Octobre != 0 || row7.V_Octobre != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois d'Octobre. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Novembre == 0 && (row7.MB_Novembre != 0 || row7.V_Novembre != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Novembre. Veuillez corriger le fichier : elle est à zéro.");
									}

									if (row7.CA_Decembre == 0 && (row7.MB_Decembre != 0 || row7.V_Decembre != 0)) {
										throw new Exception("Une des valeurs est fausse dans le fichier '"
												+ context.nom_fichier
												+ "' pour le mois de Décembre. Veuillez corriger le fichier : elle est à zéro.");
									}
									nb_line_tJavaRow_3++;
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row6,row2,row3,row4,row14,row5)
				// outputs:(vente,vente_output_good)
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_4 - inputs:(after_tFileList_1) outputs:(row14,row14) |
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_5 - inputs:(after_tFileList_1) outputs:(row5,row5) |
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = controle_qualite_objectif.class.getClassLoader().getResourceAsStream(
					"projet_bi_3/controle_qualite_objectif_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = controle_qualite_objectif.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : controle_qualite_objectif");
		}
...
/************************************************************************************************
 * 339923 characters generated by Talend Open Studio for Data Integration on the
 * 23 mai 2019 19:45:13 CEST
 ************************************************************************************************/