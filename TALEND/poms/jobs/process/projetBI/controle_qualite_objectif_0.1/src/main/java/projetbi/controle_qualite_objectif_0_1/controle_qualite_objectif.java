...
package projetbi.controle_qualite_objectif_0_1;
...
public static class venteStruct implements routines.system.IPersistableRow<venteStruct> {
    final static byte[] commonByteArrayLock_PROJETBI_controle_qualite_objectif = new byte[0];
    static byte[] commonByteArray_PROJETBI_controle_qualite_objectif = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_controle_qualite_objectif) {
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_controle_qualite_objectif.length) {
				if(length < 1024 && commonByteArray_PROJETBI_controle_qualite_objectif.length == 0) {
   					commonByteArray_PROJETBI_controle_qualite_objectif = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_controle_qualite_objectif = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_controle_qualite_objectif, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_controle_qualite_objectif, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if(vente != null) { 
    ...
    if(true){
	throw new Exception("Une ou plusieurs ligne n'a/ont pas pu être inséré car aucun augun magasins n'est la/les ville(s) spécifié dans le fichier: '"+  context.nom_fichier +"'. Veuillez corriger le fichier.");
}
    nb_line_tJavaRow_1++;   
...
if(vente_output_good != null) { 
	...
	throw new Exception("Un chiffre négative ou une case vide a été trouvé dans le fichier: '"+  context.nom_fichier +"'. Veuillez corriger le fichier.");
}
...
if(row7 != null) { 
	...
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Janvier. Veuillez corriger le fichier");
}

if (row7.CA_Fevrier == 0 && (row7.MB_Fevrier != 0 || row7.V_Fevrier != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Février. Veuillez corriger le fichier");
}

if (row7.CA_Mars == 0 && (row7.MB_Mars != 0 || row7.V_Mars != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Mars. Veuillez corriger le fichier");
}

if (row7.CA_Avril == 0 && (row7.MB_Avril != 0 || row7.V_Avril != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois d'Avril. Veuillez corriger le fichier");
}

if (row7.CA_Mai == 0 && (row7.MB_Mai != 0 || row7.V_Mai != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Mai. Veuillez corriger le fichier");
}

if (row7.CA_Juin == 0 && (row7.MB_Juin != 0 || row7.V_Juin != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Juin. Veuillez corriger le fichier");
}

if (row7.CA_Juillet == 0 && (row7.MB_Juillet != 0 || row7.V_Juillet != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Juillet. Veuillez corriger le fichier");
}

if (row7.CA_Aout == 0 && (row7.MB_Aout != 0 || row7.V_Aout != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois d'Août. Veuillez corriger le fichier");
}

if (row7.CA_Septembre == 0 && (row7.MB_Septembre != 0 || row7.V_Septembre != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Septembre. Veuillez corriger le fichier");
}

if (row7.CA_Octobre == 0 && (row7.MB_Octobre != 0 || row7.V_Octobre != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois d'Octobre. Veuillez corriger le fichier");
}

if (row7.CA_Novembre == 0 && (row7.MB_Novembre != 0 || row7.V_Novembre != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Novembre. Veuillez corriger le fichier");
}

if (row7.CA_Decembre == 0 && (row7.MB_Decembre != 0 || row7.V_Decembre != 0)){
	throw new Exception("Une des valeurs est fausse dans le fichier '"+  context.nom_fichier +"' pour le mois de Décembre. Veuillez corriger le fichier");
}
    nb_line_tJavaRow_3++;   
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = controle_qualite_objectif.class.getClassLoader().getResourceAsStream("projetbi/controle_qualite_objectif_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     337059 characters generated by Talend Open Studio for Data Integration 
