...
package projet_bi_5.dimension_produit_0_1;
...
/**
 * Job: dimension_produit Purpose: Initialise la dimension produit<br>
 * Description: Lit un fichier Excel pour en extraire les produit à ajouter en BDD <br>
 * @author user@talend.com
 * @version 7.2.1.20190325_1906-M4
 * @status 
 */
public class dimension_produit implements TalendJob {
...
public String getMask_produits(){
	...
	private final String jobName = "dimension_produit";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_WKqikGO8EemeCqdBCCBwiA", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_WKqikGO8EemeCqdBCCBwiA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dimension_produit.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dimension_produit.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class efface_indicateurStruct implements routines.system.IPersistableRow<efface_indicateurStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_dimension_produit = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_dimension_produit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_dimension_produit.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_dimension_produit.length == 0) {
   					commonByteArray_PROJET_BI_5_dimension_produit = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_dimension_produit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_dimension_produit, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_dimension_produit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_dimension_produit) {
...
int count_tDBOutput_2=0;
	    ...
	    String delete_tDBOutput_2 = "DELETE FROM `" + "produit" + "` WHERE `id` = ?";
            ...
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 2) {
								row8.type_produit = null;
							} else {
	                         		
        	row8.type_produit = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 					    ...
 					    boolean forceLooprow9 = false;
 							...
 							row9Struct row9ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row9HashKey.Nom = row8.type_produit ;
...
row9Struct row9 = new row9Struct();
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(context.mask_produits);  
 ...
 */
	NB_ITERATE_tRunJob_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate7", 1, "exec" + NB_ITERATE_tRunJob_1);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate7", 2, "exec" + NB_ITERATE_tRunJob_1);
						}				
	...
	currentComponent="tDBOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("produits" + iterateId, 0, 0);
...
String tableName_tDBOutput_1 = "produit";
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "produit" + "` SET `type_produit` = ? WHERE `type_produit` = ?";
	    
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "produit" + "` (`type_produit`) VALUES (?)";
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "produits", false));
...
produits_tmp.id = 0;
produits_tmp.type_produit = row1.Nom ;
...
if(produits != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			//produits
				...
				if(execStat){
					runStat.updateStatOnConnection("produits"+iterateId,1, 1);
				} 
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(produits.type_produit == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, produits.type_produit);
}


                    if(produits.type_produit == null) {
pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, produits.type_produit);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, produits.type_produit);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("produits"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tAdvancedHash_row9";
		...
		int tos_count_tAdvancedHash_row9 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row8,row9) outputs:(efface_indicateur)
...
if(row2.Nom == null){
	...
	finder_tUniqRow_1.Nom = row2.Nom.toLowerCase();
}	
...
if(row2.Nom == null){
	...
	new_tUniqRow_1.Nom = row2.Nom.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row9 == null){ 
	
	row9 = new row9Struct();
}row9.Nom = row2.Nom;			if(row9 == null){ 
 ...
 */
	...
	NB_ITERATE_tRunJob_3++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate8", 1, "exec" + NB_ITERATE_tRunJob_3);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate8", 2, "exec" + NB_ITERATE_tRunJob_3);
						}				
 ...
 */
    ...
    public static void main(String[] args){
        final dimension_produit dimension_produitClass = new dimension_produit();

        int exitCode = dimension_produitClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_produit.class.getClassLoader().getResourceAsStream("projet_bi_5/dimension_produit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dimension_produit.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimension_produit");
        }
