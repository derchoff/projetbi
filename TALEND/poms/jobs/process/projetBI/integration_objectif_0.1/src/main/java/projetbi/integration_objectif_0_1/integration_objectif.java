...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "vente" + "` SET `id_produit` = ?,`id_magasin` = ?,`id_devise` = ?,`id_date` = ?,`id_indicateur` = ?,`reel` = ?,`objectif` = ? WHERE `id_produit` = ? AND `id_magasin` = ? AND `id_date` = ? AND `id_indicateur` = ?";
	    
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "vente" + "` (`id_produit`,`id_magasin`,`id_devise`,`id_date`,`id_indicateur`,`reel`,`objectif`) VALUES (?,?,?,?,?,?,?)";
...
} else {pstmtUpdate_tDBOutput_1.setFloat(7, ventes.objectif);
}


                    pstmtUpdate_tDBOutput_1.setInt(8 + count_tDBOutput_1, ventes.id_produit);


                    pstmtUpdate_tDBOutput_1.setInt(9 + count_tDBOutput_1, ventes.id_magasin);


                    pstmtUpdate_tDBOutput_1.setInt(10 + count_tDBOutput_1, ventes.id_date);


                    pstmtUpdate_tDBOutput_1.setInt(11 + count_tDBOutput_1, ventes.id_indicateur);
...
} else {pstmtInsert_tDBOutput_1.setFloat(7, ventes.objectif);
}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projetbi.gestion_dossier_reussi_0_1.gestion_dossier_reussi childJob_tRunJob_3 = new projetbi.gestion_dossier_reussi_0_1.gestion_dossier_reussi();
	    // pass DataSources
