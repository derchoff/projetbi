...
package projetbi.gestion_dossier_reussi_0_1;
...
/**
 * Job: gestion_dossier_reussi Purpose: archiver les fichiers avec une
 * intégration réussi<br>
 * Description: <br>
 * 
...
public class gestion_dossier_reussi implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETBI_gestion_dossier_reussi = new byte[0];
		static byte[] commonByteArray_PROJETBI_gestion_dossier_reussi = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETBI_gestion_dossier_reussi.length) {
					if (length < 1024 && commonByteArray_PROJETBI_gestion_dossier_reussi.length == 0) {
						commonByteArray_PROJETBI_gestion_dossier_reussi = new byte[1024];
					} else {
						commonByteArray_PROJETBI_gestion_dossier_reussi = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETBI_gestion_dossier_reussi, 0, length);
				strReturn = new String(commonByteArray_PROJETBI_gestion_dossier_reussi, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETBI_gestion_dossier_reussi) {
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(context.excel_output_done_repository
						+ TalendDate.getDate("YYYY-MM-dd") + "/" + TalendDate.getDate("YYYY-MM-dd") + ".log"))
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					if (row1.Heure != null) {
						sb_tFileOutputDelimited_1.append(row1.Heure);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row1.NomFichierExcel != null) {
						sb_tFileOutputDelimited_1.append(row1.NomFichierExcel);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row1.MessageErreur != null) {
						sb_tFileOutputDelimited_1.append(row1.MessageErreur);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row1.NomJobTalend != null) {
						sb_tFileOutputDelimited_1.append(row1.NomJobTalend);
					}
					...
					String desDirName_tFileCopy_1 = context.excel_output_done_repository + "/"
					...
					if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())) {
						...
						java.io.File isRemoved_tFileCopy_1 = new java.io.File(
								context.excel_input_repository + "/" + context.nom_fichier);
					...
					String insert_tDBOutput_1 = "INSERT INTO `" + "data_update"
							+ "` (`nom_fichier`,`date_update`) VALUES (?,?)";
					...
					for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
						...
						if (row3.nom_fichier == null) {
							...
							pstmt_tDBOutput_1.setString(1, row3.nom_fichier);
						}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = gestion_dossier_reussi.class.getClassLoader()
					.getResourceAsStream("projetbi/gestion_dossier_reussi_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = gestion_dossier_reussi.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : gestion_dossier_reussi");
		}
...
/************************************************************************************************
 * 136298 characters generated by Talend Open Studio for Data Integration on the
 * 13 juin 2019 14:29:17 SBT
 ************************************************************************************************/