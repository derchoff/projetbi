...
package projet_bi_5.gestion_dossier_reussi_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_gestion_dossier_reussi = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_gestion_dossier_reussi = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_gestion_dossier_reussi.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_gestion_dossier_reussi.length == 0) {
   					commonByteArray_PROJET_BI_5_gestion_dossier_reussi = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_gestion_dossier_reussi = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_gestion_dossier_reussi, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_gestion_dossier_reussi, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_gestion_dossier_reussi) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gestion_dossier_reussi.class.getClassLoader().getResourceAsStream("projet_bi_5/gestion_dossier_reussi_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
