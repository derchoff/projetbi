...
package projet_bi_2.verification_annee_fichier_0_1;
...
public static class row_talendStats_STATSStruct implements routines.system.IPersistableRow<row_talendStats_STATSStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_2_verification_annee_fichier = new byte[0];
    static byte[] commonByteArray_PROJET_BI_2_verification_annee_fichier = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_2_verification_annee_fichier.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_2_verification_annee_fichier.length == 0) {
   					commonByteArray_PROJET_BI_2_verification_annee_fichier = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_2_verification_annee_fichier = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_2_verification_annee_fichier, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_2_verification_annee_fichier, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_2_verification_annee_fichier) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = verification_annee_fichier.class.getClassLoader().getResourceAsStream("projet_bi_2/verification_annee_fichier_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
