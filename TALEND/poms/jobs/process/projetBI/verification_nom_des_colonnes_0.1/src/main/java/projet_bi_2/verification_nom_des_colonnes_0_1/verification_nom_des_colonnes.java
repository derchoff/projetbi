...
package projet_bi_2.verification_nom_des_colonnes_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_2_verification_nom_des_colonnes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_2_verification_nom_des_colonnes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_2_verification_nom_des_colonnes.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_2_verification_nom_des_colonnes.length == 0) {
   					commonByteArray_PROJET_BI_2_verification_nom_des_colonnes = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_2_verification_nom_des_colonnes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_2_verification_nom_des_colonnes, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_2_verification_nom_des_colonnes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_2_verification_nom_des_colonnes) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = verification_nom_des_colonnes.class.getClassLoader().getResourceAsStream("projet_bi_2/verification_nom_des_colonnes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
