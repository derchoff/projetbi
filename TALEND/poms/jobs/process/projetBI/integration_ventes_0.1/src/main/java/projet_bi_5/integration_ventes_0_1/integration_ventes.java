...
package projet_bi_5.integration_ventes_0_1;
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_ventes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_ventes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_integration_ventes.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_integration_ventes.length == 0) {
   					commonByteArray_PROJET_BI_5_integration_ventes = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_integration_ventes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_integration_ventes, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_integration_ventes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_integration_ventes) {
...
public static class reel_objectif_compaStruct implements routines.system.IPersistableRow<reel_objectif_compaStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_ventes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_ventes = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(reel_objectif_compaStruct other) {
...
public static class ventes_controle_reel_objectifStruct implements routines.system.IPersistableRow<ventes_controle_reel_objectifStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_ventes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_ventes = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ventes_controle_reel_objectifStruct other) {
...
public static class convertiesStruct implements routines.system.IPersistableRow<convertiesStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_integration_ventes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_integration_ventes = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final convertiesStruct other = (convertiesStruct) obj;
	...
	public void copyDataTo(convertiesStruct other) {
	...
	public void copyKeysDataTo(convertiesStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(convertiesStruct other) {
...
convertiesStruct converties = new convertiesStruct();
row19Struct row19 = new row19Struct();
row6Struct row6 = new row6Struct();
ventesStruct ventes = new ventesStruct();
row15Struct row15 = new row15Struct();
row14Struct row14 = new row14Struct();
ventes_controle_reel_objectifStruct ventes_controle_reel_objectif = new ventes_controle_reel_objectifStruct();
reel_objectif_compaStruct reel_objectif_compa = new reel_objectif_compaStruct();
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate5", 1, "exec" + NB_ITERATE_tSetGlobalVar_1);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate5", 2, "exec" + NB_ITERATE_tSetGlobalVar_1);
						}				
 ...
 */
	...
	NB_ITERATE_tFileExcelWorkbookOpen_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate10", 1, "exec" + NB_ITERATE_tFileExcelWorkbookOpen_1);
					//Thread.sleep(1000);
				}				
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "Villes,Code postal,"+row9.nom_colonnes;
		if(obj_tRunJob_3!=null) {
		...
		projet_bi_5.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes childJob_tRunJob_3 = new projet_bi_5.verification_nom_des_colonnes_0_1.verification_nom_des_colonnes();
	    // pass DataSources
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate10", 2, "exec" + NB_ITERATE_tFileExcelWorkbookOpen_1);
						}				
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
		...
		projet_bi_5.controle_qualite_reel_0_1.controle_qualite_reel childJob_tRunJob_5 = new projet_bi_5.controle_qualite_reel_0_1.controle_qualite_reel();
	    // pass DataSources
 ...
 */
	...
	NB_ITERATE_tFileInputExcel_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("ventes_controle_reel_objectif", 3, 0);
					}           			
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "vente" + "` SET `id` = ?,`id_produit` = ?,`id_magasin` = ?,`id_devise` = ?,`id_date` = ?,`id_indicateur` = ?,`reel` = ? WHERE `id` = ?";
	    
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "vente" + "` (`id`,`id_produit`,`id_magasin`,`id_devise`,`id_date`,`id_indicateur`,`reel`) VALUES (?,?,?,?,?,?,?)";
	...
	currentComponent="tJavaRow_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("reel_objectif_compa" + iterateId, 0, 0);
	...
	currentComponent="tMap_4";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("ventes_controle_reel_objectif" + iterateId, 0, 0);
...
// ###############################
// # Outputs initialization
reel_objectif_compaStruct reel_objectif_compa_tmp = new reel_objectif_compaStruct();
// ###############################
...
ventes_controle_reel_objectifStruct ventes_controle_reel_objectif_tmp = new ventes_controle_reel_objectifStruct();
// ###############################
	...
	currentComponent="tJavaRow_3";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("converties" + iterateId, 0, 0);
...
// ###############################
// # Outputs initialization
convertiesStruct converties_tmp = new convertiesStruct();
// ###############################
...
// # Output table : 'converties'
converties_tmp.Villes = row1.Villes ;
converties_tmp.Code_postal = row1.Code_postal ;
converties_tmp.CA_Juin = Float.parseFloat(row1.CA_Juin);
converties_tmp.MB_Juin = Float.parseFloat(row1.MB_Juin);
converties_tmp.V_Juin = Float.parseFloat(row1.V_Juin);
converties = converties_tmp;
// ###############################
...
if(converties != null) { 
	...
	currentComponent="tJavaRow_3";
			...
			//converties
				...
				if(execStat){
					runStat.updateStatOnConnection("converties"+iterateId,1, 1);
				} 
...
if (converties.MB_Juin == 0.0f && (converties.CA_Juin != 0.0f || converties.V_Juin != 0.0f)){
	globalMap.put("put_mb_warn_zero", true);
	globalMap.put("ville_warn", converties.Villes);
}
...
row19.Villes=converties.Villes;
row19.Code_postal=converties.Code_postal;
row19.CA_Juin=converties.CA_Juin;
row19.MB_Juin=converties.MB_Juin;
row19.V_Juin=converties.V_Juin;
    nb_line_tJavaRow_3++;   
...
*/
	String[] pivotKeysArray = {"CA_Juin","MB_Juin","V_Juin"};

	for (String field : pivotKeysArray) {
		row6.Villes=row19.Villes;
row6.Code_postal=row19.Code_postal;

		row6.pivot_key = field;
		try {
			row6.pivot_value = row19.getClass().getDeclaredField(field).get(row19).toString();
		} catch (Exception e) {
...
ventes = null;
ventes_controle_reel_objectif = null;
...
ventes_tmp.ville = row6.Villes ;
ventes = ventes_tmp;

// # Output table : 'ventes_controle_reel_objectif'
ventes_controle_reel_objectif_tmp.id = Long.valueOf(row3.id)*Long.valueOf(1000000)+Long.valueOf(row5.id)*Long.valueOf(100000)+Long.valueOf(row2.id)*Long.valueOf(10000)+Long.valueOf(row4.id) ;
ventes_controle_reel_objectif_tmp.reel = Float.parseFloat(row6.pivot_value) ;
ventes_controle_reel_objectif_tmp.ville = row6.Villes ;
ventes_controle_reel_objectif = ventes_controle_reel_objectif_tmp;
}  // closing inner join bracket (2)
// ###############################
...
}row14.id = ventes.id;			row14.id_produit = ventes.id_produit;			row14.id_magasin = ventes.id_magasin;			row14.id_devise = ventes.id_devise;			row14.id_date = ventes.id_date;			row14.id_indicateur = ventes.id_indicateur;			row14.reel = ventes.reel;			row14.objectif = ventes.objectif;			row14.produit = ventes.produit;			row14.ville = ventes.ville;					
...
if(row15 != null) { 
    ...
    if (true) {
throw new Exception("La ville " + row15.ville +  " est en double pour le produit " + row15.produit);
}
    nb_line_tJavaRow_2++;   
...
} else {pstmtUpdate_tDBOutput_1.setLong(1, row14.id);
}

                    pstmtUpdate_tDBOutput_1.setInt(2, row14.id_produit);

                    pstmtUpdate_tDBOutput_1.setInt(3, row14.id_magasin);

                    pstmtUpdate_tDBOutput_1.setInt(4, row14.id_devise);

                    pstmtUpdate_tDBOutput_1.setInt(5, row14.id_date);

                    pstmtUpdate_tDBOutput_1.setInt(6, row14.id_indicateur);

                    pstmtUpdate_tDBOutput_1.setFloat(7, row14.reel);


                    if(row14.id == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(8 + count_tDBOutput_1, row14.id);
}
...
} else {pstmtInsert_tDBOutput_1.setLong(1, row14.id);
}

                        pstmtInsert_tDBOutput_1.setInt(2, row14.id_produit);

                        pstmtInsert_tDBOutput_1.setInt(3, row14.id_magasin);

                        pstmtInsert_tDBOutput_1.setInt(4, row14.id_devise);

                        pstmtInsert_tDBOutput_1.setInt(5, row14.id_date);

                        pstmtInsert_tDBOutput_1.setInt(6, row14.id_indicateur);

                        pstmtInsert_tDBOutput_1.setFloat(7, row14.reel);
...
// Start of branch "ventes_controle_reel_objectif"
if(ventes_controle_reel_objectif != null) { 
	...
	currentComponent="tMap_4";
			...
			//ventes_controle_reel_objectif
			//ventes_controle_reel_objectif


			
				if(execStat){
					runStat.updateStatOnConnection("ventes_controle_reel_objectif"+iterateId,1, 1);
				} 
 					    ...
 					    boolean forceLooprow13 = false;
 							...
 							row13Struct row13ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row13HashKey.id = ventes_controle_reel_objectif.id ;
...
reel_objectif_compa = null;

if(!rejectedInnerJoin_tMap_4 ) {

// # Output table : 'reel_objectif_compa'
reel_objectif_compa_tmp.reel = ventes_controle_reel_objectif.reel  ;
reel_objectif_compa_tmp.objectif = row13.objectif;
reel_objectif_compa_tmp.ville = ventes_controle_reel_objectif.ville ;
reel_objectif_compa = reel_objectif_compa_tmp;
}  // closing inner join bracket (2)
// ###############################
 ...
 */
// Start of branch "reel_objectif_compa"
if(reel_objectif_compa != null) { 
	...
	currentComponent="tJavaRow_1";
			...
			//reel_objectif_compa
				...
				if(execStat){
					runStat.updateStatOnConnection("reel_objectif_compa"+iterateId,1, 1);
				} 
			

		

    if(reel_objectif_compa.reel > 2.0f*reel_objectif_compa.objectif || reel_objectif_compa.reel < reel_objectif_compa.objectif/2.0f){
	globalMap.put("put_warn", true);
	globalMap.put("ville_warn", reel_objectif_compa.ville);
}
...
} // End of branch "reel_objectif_compa"
...
} // End of branch "ventes_controle_reel_objectif"
...
globalMap.put("tJavaRow_3_NB_LINE",nb_line_tJavaRow_3);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("converties"+iterateId,2, 0); 
			 	}
			}
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("ventes_controle_reel_objectif"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tJavaRow_1_NB_LINE",nb_line_tJavaRow_1);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("reel_objectif_compa"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	NB_ITERATE_tJava_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate12", 1, "exec" + NB_ITERATE_tJava_1);
					//Thread.sleep(1000);
				}				
...
end_Hash.put("tJava_1", System.currentTimeMillis());
   			...
   			if ((boolean)globalMap.get("put_warn") == true) {
   			...
   			if ((boolean)globalMap.get("put_mb_warn_zero") == true) {
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate12", 2, "exec" + NB_ITERATE_tJava_1);
						}				
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "ERROR","","Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif pour la ville " +((String)globalMap.get("ville_warn")) + ".","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 5, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	tLogCatcher_1Process(globalMap);
	talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 5, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif pour la ville " +((String)globalMap.get("ville_warn")) + "."); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : les valeurs son toutes à zéro pour une ligne pour la ville " +((String)globalMap.get("ville_warn")) + ".","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 4, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : les valeurs son toutes à zéro pour une ligne pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	tLogCatcher_1Process(globalMap);
	talendLogs_LOGS.addMessage("tWarn", "tWarn_2", 4, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : les valeurs son toutes à zéro pour une ligne pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_2_WARN_MESSAGES", "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : les valeurs son toutes à zéro pour une ligne pour la ville " +((String)globalMap.get("ville_warn")) + "."); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "WARN","","Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : la MB est à zéro pour la ville " +((String)globalMap.get("ville_warn")) + ".","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_3", 4, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : la MB est à zéro pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	tLogCatcher_1Process(globalMap);
	talendLogs_LOGS.addMessage("tWarn", "tWarn_3", 4, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : la MB est à zéro pour la ville " +((String)globalMap.get("ville_warn")) + ".", 42);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_3_WARN_MESSAGES", "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : la MB est à zéro pour la ville " +((String)globalMap.get("ville_warn")) + "."); 
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		projet_bi_5.gestion_dossier_reussi_0_1.gestion_dossier_reussi childJob_tRunJob_4 = new projet_bi_5.gestion_dossier_reussi_0_1.gestion_dossier_reussi();
	    // pass DataSources
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row6,row2,row3,row5,row12,row4) outputs:(ventes,ventes_controle_reel_objectif)
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.db_pwd; 
        	...
        	row4.code_postal = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row13";
		...
		int tos_count_tAdvancedHash_row13 = 0;
			   		...
			   		// source node:tDBInput_8 - inputs:(after_tFileList_1) outputs:(row13,row13) | target node:tAdvancedHash_row13 - inputs:(row13) outputs:()
			   		// linked node: tMap_4 - inputs:(ventes_controle_reel_objectif,row13) outputs:(reel_objectif_compa)
		...
		int tos_count_tDBInput_8 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_8 = null;
			    ...
			    java.lang.Class.forName(driverClass_tDBInput_8);
					String dbUser_tDBInput_8 = context.db_user;
					
					
					
	final String decryptedPassword_tDBInput_8 = context.db_pwd; 
					
					String dbPwd_tDBInput_8 = decryptedPassword_tDBInput_8;
				
				String url_tDBInput_8 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/" + context.db_database + "?" + "noDatetimeStringSync=true&useSSL=false";
            ...
            row13.id = rs_tDBInput_8.getLong(1);
            ...
            row13.objectif = rs_tDBInput_8.getFloat(2);
            if(rs_tDBInput_8.wasNull()){
                    row13.objectif = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row13";
			...
			//row13
				...
				row13_HashRow.objectif = row13.objectif;
...
///////////////////////		
	    		...
	    		if(row16.father_pid != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row16.father_pid)			
					          ;	
	    		...
	    		if(row16.context != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row16.context)			
					          ;	
							
	    		} //			
    			   				
	    		if(row16.priority != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row16.priority)			
					          ;	
 ...
 */
	...
	String message_tSendMail_1 = (("Message d'avertissement: " + String.valueOf(row17.message)) == null || "".equals("Message d'avertissement: " + String.valueOf(row17.message))) ? "\"\"" : ("Message d'avertissement: " + String.valueOf(row17.message)) ;
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "integration_ventes";
		if(obj_tRunJob_6!=null) {
		...
		obj_tRunJob_6 = String.valueOf(row17.message);
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param log_warning=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param log_warning=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("log_warning", obj_tRunJob_6);
	
	
		projet_bi_5.gestion_dossier_avertissement_0_1.gestion_dossier_avertissement childJob_tRunJob_6 = new projet_bi_5.gestion_dossier_avertissement_0_1.gestion_dossier_avertissement();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integration_ventes.class.getClassLoader().getResourceAsStream("projet_bi_5/integration_ventes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
