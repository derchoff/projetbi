...
package projet_bi_4.integration_ventes_0_1;
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_4_integration_ventes = new byte[0];
    static byte[] commonByteArray_PROJET_BI_4_integration_ventes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_4_integration_ventes.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_4_integration_ventes.length == 0) {
   					commonByteArray_PROJET_BI_4_integration_ventes = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_4_integration_ventes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_4_integration_ventes, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_4_integration_ventes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_4_integration_ventes) {
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		projet_bi_4.controle_qualite_reel_0_1.controle_qualite_reel childJob_tRunJob_5 = new projet_bi_4.controle_qualite_reel_0_1.controle_qualite_reel();
	    // pass DataSources
...
} else {pstmtUpdate_tDBOutput_1.setLong(8 + count_tDBOutput_1, ventes.id);
}
...
if(reel_objectif_compa != null) { 
    ...
    if(reel_objectif_compa.reel > 2*reel_objectif_compa.objectif || reel_objectif_compa.reel < reel_objectif_compa.objectif/2){
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "ERROR","","Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif.","", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 5, "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif.", 42);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Le fichier "+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")) +" a été intégré mais des anomalies ont été détecté dans les données : le réel est très supérieur à l'objectif."); 
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integration_ventes.class.getClassLoader().getResourceAsStream("projet_bi_4/integration_ventes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     390029 characters generated by Talend Open Studio for Data Integration 
 *     on the 19 juin 2019 01:49:01 CEST
 ************************************************************************************************/