 ...
 * @status
 */
public class tets implements TalendJob {
	...
	private final String jobName = "tets";
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("__cRrYGRFEem1D8Ft0pk_Ew", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("__cRrYGRFEem1D8Ft0pk_Ew", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tets.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PROJETBI_tets = new byte[0];
		static byte[] commonByteArray_PROJETBI_tets = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETBI_tets) {

				try {

					int length = 0;

					this.mois = (List) dis.readObject();
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "mois", });
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					public List getRandommois() {

						return projetBi.getNormalizedMonthList();
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					row1.mois = randtRowGenerator_1.getRandommois();
...
///////////////////////		
					...
					if (row1.mois != null) { //
						row_tLogRow_1[0] = String.valueOf(row1.mois);
	...
	public static class row_talendStats_STATSStruct
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETBI_tets.length) {
					if (length < 1024 && commonByteArray_PROJETBI_tets.length == 0) {
						commonByteArray_PROJETBI_tets = new byte[1024];
					} else {
						commonByteArray_PROJETBI_tets = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETBI_tets, 0, length);
				strReturn = new String(commonByteArray_PROJETBI_tets, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final tets tetsClass = new tets();

		int exitCode = tetsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tets.class.getClassLoader()
					.getResourceAsStream("projetbi/tets_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tets.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tets");
		}
...
/************************************************************************************************
 * 97983 characters generated by Talend Open Studio for Data Integration on the
 * 21 avril 2019 17:21:14 CEST
 ************************************************************************************************/