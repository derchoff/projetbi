 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		projet_bi_4.dimension_indicateurs_0_1.dimension_indicateurs childJob_tRunJob_1 = new projet_bi_4.dimension_indicateurs_0_1.dimension_indicateurs();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		projet_bi_4.dimension_produit_0_1.dimension_produit childJob_tRunJob_2 = new projet_bi_4.dimension_produit_0_1.dimension_produit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projet_bi_4.integration_magasins_0_1.integration_magasins childJob_tRunJob_3 = new projet_bi_4.integration_magasins_0_1.integration_magasins();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		projet_bi_4.dimension_date_0_1.dimension_date childJob_tRunJob_6 = new projet_bi_4.dimension_date_0_1.dimension_date();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		projet_bi_4.integration_objectif_0_1.integration_objectif childJob_tRunJob_5 = new projet_bi_4.integration_objectif_0_1.integration_objectif();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		projet_bi_4.integration_ventes_0_1.integration_ventes childJob_tRunJob_4 = new projet_bi_4.integration_ventes_0_1.integration_ventes();
	    // pass DataSources
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PROJET_BI_4_MAIN = new byte[0];
    static byte[] commonByteArray_PROJET_BI_4_MAIN = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_4_MAIN.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_4_MAIN.length == 0) {
   					commonByteArray_PROJET_BI_4_MAIN = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_4_MAIN = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_4_MAIN, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_4_MAIN, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_4_MAIN) {
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		projet_bi_4.gestion_dossier_echouer_0_1.gestion_dossier_echouer childJob_tRunJob_8 = new projet_bi_4.gestion_dossier_echouer_0_1.gestion_dossier_echouer();
	    // pass DataSources
 ...
 */
	...
	String smtpHost_tSendMail_2 = context.smtp_server;
        String smtpPort_tSendMail_2 = context.smtp_port;
	String from_tSendMail_2 = (context.mail_send_darties);
    String to_tSendMail_2 = (context.mail_si_darties).replace(";",",");
    String cc_tSendMail_2 = (("")==null || "".equals(""))?null:("").replace(";",",");
    String bcc_tSendMail_2 = (("")==null || "".equals(""))?null:("").replace(";",",");
    String subject_tSendMail_2 = ("Fichier integration avertissement");
	...
	String message_tSendMail_2 = (("Message d'avertissement: " + String.valueOf(row5.message)) == null || "".equals("Message d'avertissement: " + String.valueOf(row5.message))) ? "\"\"" : ("Message d'avertissement: " + String.valueOf(row5.message)) ;
	...
	final String decryptedPassword_tSendMail_2 = context.mail_send_password; 
				
				
				return new javax.mail.PasswordAuthentication(context.mail_send_darties, decryptedPassword_tSendMail_2); 
				}         
			});   
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = (String)globalMap.get("nom_fichier");
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param nom_fichier=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param nom_fichier=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("nom_fichier", obj_tRunJob_7);
	
		obj_tRunJob_7 = (String)globalMap.get("nom_job_talend");
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param nom_job_talend=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param nom_job_talend=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("nom_job_talend", obj_tRunJob_7);
	
		obj_tRunJob_7 = String.valueOf(row5.message);
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param log_warning=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param log_warning=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("log_warning", obj_tRunJob_7);
	
	
		projet_bi_4.gestion_dossier_avertissement_0_1.gestion_dossier_avertissement childJob_tRunJob_7 = new projet_bi_4.gestion_dossier_avertissement_0_1.gestion_dossier_avertissement();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MAIN.class.getClassLoader().getResourceAsStream("projet_bi_4/main_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     301830 characters generated by Talend Open Studio for Data Integration 
 *     on the 19 juin 2019 01:49:02 CEST
 ************************************************************************************************/