...
package projetbi.dimension_date_0_1;
...
public static class datesStruct implements routines.system.IPersistableRow<datesStruct> {
    final static byte[] commonByteArrayLock_PROJETBI_dimension_date = new byte[0];
    static byte[] commonByteArray_PROJETBI_dimension_date = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETBI_dimension_date.length) {
				if(length < 1024 && commonByteArray_PROJETBI_dimension_date.length == 0) {
   					commonByteArray_PROJETBI_dimension_date = new byte[1024];
				} else {
   					commonByteArray_PROJETBI_dimension_date = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETBI_dimension_date, 0, length);
			strReturn = new String(commonByteArray_PROJETBI_dimension_date, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETBI_dimension_date) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_date.class.getClassLoader().getResourceAsStream("projetbi/dimension_date_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     167325 characters generated by Talend Open Studio for Data Integration 
