...
package projet_bi_2.dimension_date_0_1;
...
public class dimension_date implements TalendJob {
	...
	private final String projectName = "PROJET_BI_2";
	...
	public static class datesStruct implements routines.system.IPersistableRow<datesStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_2_dimension_date = new byte[0];
		static byte[] commonByteArray_PROJET_BI_2_dimension_date = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_2_dimension_date.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_2_dimension_date.length == 0) {
						commonByteArray_PROJET_BI_2_dimension_date = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_2_dimension_date = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_2_dimension_date, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_2_dimension_date, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_2_dimension_date) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_2 = "UPDATE `" + "date"
						+ "` SET `id` = ?,`mois` = ?,`annee` = ?,`datetime` = ? WHERE `datetime` = ?";
...
// Start of branch "old_dates"
					if (old_dates != null) {
						...
						if (old_dates.datetime != null) {
							pstmtUpdate_tDBOutput_2.setTimestamp(5 + count_tDBOutput_2,
									new java.sql.Timestamp(old_dates.datetime.getTime()));
						} else {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimension_date.class.getClassLoader()
					.getResourceAsStream("projet_bi_2/dimension_date_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 169891 characters generated by Talend Open Studio for Data Integration on the
 * 23 mai 2019 15:38:16 CEST
 ************************************************************************************************/