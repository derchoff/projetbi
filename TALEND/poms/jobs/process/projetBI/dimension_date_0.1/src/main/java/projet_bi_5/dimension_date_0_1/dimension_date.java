...
package projet_bi_5.dimension_date_0_1;
...
public static class datesStruct implements routines.system.IPersistableRow<datesStruct> {
    final static byte[] commonByteArrayLock_PROJET_BI_5_dimension_date = new byte[0];
    static byte[] commonByteArray_PROJET_BI_5_dimension_date = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJET_BI_5_dimension_date.length) {
				if(length < 1024 && commonByteArray_PROJET_BI_5_dimension_date.length == 0) {
   					commonByteArray_PROJET_BI_5_dimension_date = new byte[1024];
				} else {
   					commonByteArray_PROJET_BI_5_dimension_date = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJET_BI_5_dimension_date, 0, length);
			strReturn = new String(commonByteArray_PROJET_BI_5_dimension_date, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_BI_5_dimension_date) {
...
dates_tmp.mois = (String)Var.months.get(row1.SEQ_NUM-1) ;
dates_tmp.annee = Var.year;
dates_tmp.datetime = projetBi.getDateFromMonthAndYear(row1.SEQ_NUM-1, Var.year) ;
dates = dates_tmp;
// ###############################
...
class tRowGenerator_3Randomizer {
	public Integer getRandomSEQ_NUM3() {
		...
		return Numeric.sequence("s3" ,1 ,1 );
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "date" + "` SET `id` = ?,`mois` = ?,`annee` = ?,`datetime` = ? WHERE `id` = ?";
...
class tRowGenerator_2Randomizer {
	public Integer getRandomSEQ_NUM2() {
		...
		return Numeric.sequence("s2" ,1 ,1 );
...
old_dates_tmp.mois = (String)Var.months.get(row2.SEQ_NUM2-1) ;
old_dates_tmp.annee = Var.year;
old_dates_tmp.datetime = projetBi.getDateFromMonthAndYear(row2.SEQ_NUM2-1, Var.year) ;
...
} else {pstmtUpdate_tDBOutput_2.setInt(5 + count_tDBOutput_2, old_dates.id);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dimension_date.class.getClassLoader().getResourceAsStream("projet_bi_5/dimension_date_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     169915 characters generated by Talend Open Studio for Data Integration 
