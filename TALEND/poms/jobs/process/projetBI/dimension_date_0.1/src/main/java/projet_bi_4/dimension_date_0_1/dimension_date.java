 ...
 * Description: Ajoute les 12 mois de l'année courante Ajoute les 12 mois de
 * l'année précédente Supprime les dates de l'année N-2 <br>
 * 
...
public class dimension_date implements TalendJob {
	...
	public void tRowGenerator_3_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tRowGenerator_3_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE `" + "date"
						+ "` SET `id` = ?,`mois` = ?,`annee` = ?,`datetime` = ? WHERE `id` = ?";

				java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(update_tDBOutput_1);
				resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "date"
						+ "` (`id`,`mois`,`annee`,`datetime`) VALUES (?,?,?,?)";
...
// Start of branch "dates"
					if (dates != null) {
						...
						if (dates.id == null) {
							...
							pstmtUpdate_tDBOutput_1.setInt(1, dates.id);
						}

						if (dates.mois == null) {
							pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmtUpdate_tDBOutput_1.setString(2, dates.mois);
						}
						...
						if (dates.datetime != null) {
							...
							if (date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
								...
								pstmtUpdate_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(date_tDBOutput_1));
							}
						} else {
						...
						if (dates.id == null) {
							...
							pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, dates.id);
						}
						...
						try {
							...
							if (updateFlag_tDBOutput_1 == 0) {
								...
								if (dates.id == null) {
									...
									pstmtInsert_tDBOutput_1.setInt(1, dates.id);
								}

								if (dates.mois == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, dates.mois);
								}
	...
	public void tRowGenerator_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_2 = "UPDATE `" + "date"
						+ "` SET `id` = ?,`mois` = ?,`annee` = ?,`datetime` = ? WHERE `id` = ?";
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "date"
						+ "` (`id`,`mois`,`annee`,`datetime`) VALUES (?,?,?,?)";
...
// Start of branch "old_dates"
					if (old_dates != null) {
						...
						if (old_dates.id == null) {
							...
							pstmtUpdate_tDBOutput_2.setInt(1, old_dates.id);
						}

						if (old_dates.mois == null) {
							pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmtUpdate_tDBOutput_2.setString(2, old_dates.mois);
						}
						...
						if (old_dates.datetime != null) {
							...
							if (date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
								...
								pstmtUpdate_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(date_tDBOutput_2));
							}
						} else {
						...
						if (old_dates.id == null) {
							...
							pstmtUpdate_tDBOutput_2.setInt(5 + count_tDBOutput_2, old_dates.id);
						}
						...
						try {
							...
							if (updateFlag_tDBOutput_2 == 0) {
								...
								if (old_dates.id == null) {
									...
									pstmtInsert_tDBOutput_2.setInt(1, old_dates.id);
								}

								if (old_dates.mois == null) {
									pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(2, old_dates.mois);
								}
...
// ###############################      
	...
	public static class suppression_N_moins_2Struct
			implements routines.system.IPersistableRow<suppression_N_moins_2Struct> {
		final static byte[] commonByteArrayLock_PROJET_BI_4_dimension_date = new byte[0];
		static byte[] commonByteArray_PROJET_BI_4_dimension_date = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbProperties_tDBOutput_3 == null || dbProperties_tDBOutput_3.trim().length() == 0) {
					url_tDBOutput_3 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
							+ context.db_database + "?" + "rewriteBatchedStatements=true";
				} else {
					...
					url_tDBOutput_3 = "jdbc:mysql://" + context.db_host + ":" + context.db_port + "/"
							+ context.db_database + "?" + properties_tDBOutput_3;
				}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimension_date.class.getClassLoader()
					.getResourceAsStream("projet_bi_4/dimension_date_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimension_date.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.fichier_des_fichiers_dimensions = (String) context
							.getProperty("fichier_des_fichiers_dimensions");
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("fichier_des_fichiers_dimensions")) {
				context.fichier_des_fichiers_dimensions = (String) parentContextMap
						.get("fichier_des_fichiers_dimensions");
			}
		}
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimension_date");
		}
...
/************************************************************************************************
 * 169915 characters generated by Talend Open Studio for Data Integration on the
 * 16 juin 2019 21:22:56 CEST
 ************************************************************************************************/